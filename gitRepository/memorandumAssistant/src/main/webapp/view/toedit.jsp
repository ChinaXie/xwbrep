...
<div class="pd-20">
    ...
    <form action="" method="post" class="form form-horizontal" name="searchForm" id="searchForm" onsubmit="">
        ...
        <div class="formControls col-5">
               <input id="titleName" name="titleName" class="input-text" maxlength="100" datatype="*" nullmsg="事件主题不能为空" value="${tbMemorandum.titleName}"/>
        </div>
        <div class="col-4"> </div>
      </div>
       ...
       <div class="row cl">
        ...
        <div class="formControls col-5">
        	   <input id="starTime" name="starTime" value="<fmt:formatDate value='${tbMemorandum.startTime}' pattern='yyyy-MM-dd HH:mm'/>" placeholder="YYYY-MM-DD HH:MM" style="width: 180px" class="Wdate sf_input input-text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" datatype="*" nullmsg="开始时间不能为空" readonly="true"/>   
        </div>
        <div class="col-4"> </div>
      </div>
       ...
       <div class="row cl">
        ...
        <div class="formControls col-5">      
             <input id="endTime" name="endTime" value="<fmt:formatDate value='${tbMemorandum.endTime}' pattern='yyyy-MM-dd HH:mm'/>" placeholder="YYYY-MM-DD HH:MM" style="width: 180px" class="Wdate sf_input input-text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"  readonly="true"/>            		
        </div>
        <div class="col-4"> </div>
      </div>
      ...
      <div class="row cl">
        ...
        <div class="formControls col-5">     
        	  <textarea id="description" rows="8" cols="50" style="text-align: left;" name="description" onKeyUp="if(this.value.length > 300) this.value=this.value.substr(0,299);">${tbMemorandum.description}</textarea>
        </div>
        <div class="col-4"> </div>
      </div>
...
function btnsubmit(){
	var meid = '${tbMemorandum.id}';
	var titleName = $("#titleName").val();
	var starTime = $("#starTime").val();
	var endTime = $("#endTime").val();
	var description = $("#description").val();
	var user_key = '${tbMemorandum.userId}';
