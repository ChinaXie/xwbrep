...
*/
(function(O, M) {
    "object" === typeof module && module.exports ? (M["default"] = M, module.exports = O.document ? M(O) : M) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() {
        return M(O)
    }) : (O.Highcharts && O.Highcharts.error(16, !0), O.Highcharts = M(O))
})("undefined" !== typeof window ? window : this, function(O) {
    function M(c, p, y, G) {
        c.hasOwnProperty(p) || (c[p] = G.apply(null, y))
    }
    var J = {};
    ...
    M(J, "parts/Utilities.js", [J["parts/Globals.js"]], function(c) {
        ...
        function F(b, d) {
            return !!b && "object" === typeof b && (!d || !G(b))
        }
        function z(b) {
        ...
        function r(b) {
            ...
            return !(!F(b, !0) || z(b) || !d || !d.name || "Object" === d.name)
        }
        function K(b) {
        ...
        function D(b, d, a) {
            for (var g in b) Object.prototype.hasOwnProperty.call(b, g) && d.call(a || b[g], b[g], g, b)
        }
        c.timers = [];
        var w = c.charts,
            n = c.doc,
        ...
        c.error = function(b, d, a) {
            var g = K(b) ? "Highcharts error #" + b + ": www.highcharts.com/errors/" + b : b,
                h = function() {
                    if (d) throw Error(g);
        ...
        c.Fx.prototype = {
            dSetter: function() {
                var b = this.paths[0],
                    ...
                    h = b.length;
                if (1 === g) a = this.toD;
                else if (h === d.length && 1 > g) for (; h--;) {
                    var e = parseFloat(b[h]);
                    a[h] = isNaN(e) ? d[h] : g * parseFloat("" + (d[h] - e)) + e
                } else a = d;
            ...
            run: function(b, d, a) {
                ...
                b !== d || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date, this.start = b, this.end = d, this.unit = a, this.now = this.start, this.pos = 0, e.elem = this.elem, e.prop = this.prop, e() && 1 === c.timers.push(e) && m(u)) : (delete h.curAnim[this.prop], h.complete && 0 === Object.keys(h.curAnim).length && h.complete.call(this.elem))
            },
            step: function(b) {
                var d = +new Date,
                    a = this.options,
                ...
                if (g.attr && !g.element) b = !1;
                    ...
                    u && h && h.call(g);
                    b = !1
                } else this.pos = a.easing((d - this.startTime) / e), this.now = this.start + (this.end - this.start) * this.pos, this.update(), b = !0;
                return b
            },
            initPath: function(b, d, a) {
                ...
                function h(a, b) {
                    for (; a.length < f;) {
                        ...
                        A && (q = a.slice(a.length - t), [].splice.apply(a, [a.length, 0].concat(q)), k--)
                    }
                    a[0] = "M"
                }
                function e(a, b) {
                    for (var q = (f - a.length) / t; 0 < q && q--;) x = a.slice().splice(a.length / B - t, t * B), x[0] = b[f - t - q * t], n && (x[t - 6] = x[t - 2], x[t - 5] = x[t - 1]), [].splice.apply(a, [a.length / B, 0].concat(x)), A && q--
                }
                d = d || "";
                var c = b.startX,
                    u = b.endX,
                ...
                n && (g(d), g(a));
                if (c && u) {
                    for (k = 0; k < c.length; k++) if (c[k] === u[0]) {
                        var H = k;
                        break
                    } else if (c[0] === u[u.length - c.length + k]) {
                        H = k;
                        var q = !0;
                        break
                    } else if (c[c.length - 1] === u[u.length - c.length + k]) {
                        H = c.length - k;
                        break
                    }
        ...
        c.merge = function() {
            var b, d = arguments,
                ...
                g = function(a, b) {
                    "object" !== typeof a && (a = {});
                    D(b, function(d, e) {
                        !F(d, !0) || r(d) || z(d) ? a[e] = b[e] : a[e] = g(a[e] || {}, d)
                    });
                    return a
                };
            !0 === d[0] && (a = d[1], d = Array.prototype.slice.call(d, 2));
            var h = d.length;
            for (b = 0; b < h; b++) a = g(a, d[b]);
            return a
        };
        c.attr = function(b, d, a) {
            var g;
            y(d) ? v(a) ? b.setAttribute(d, a) : b && b.getAttribute && ((g = b.getAttribute(d)) || "class" !== d || (g = b.getAttribute(d + "Name"))) : v(d) && F(d) && D(d, function(a, d) {
                b.setAttribute(d, a)
            });
            return g
        };
        c.syncTimeout = function(b, d, a) {
            if (d) return setTimeout(b, d, a);
            b.call(0, a)
        };
        ...
        c.createElement = function(b, d, a, g, h) {
            b = n.createElement(b);
            var e = c.css;
            d && c.extend(b, d);
            h && e(b, {
        ...
        c.datePropsToTimestamps = function(b) {
            D(b, function(d, a) {
                F(d) && "function" === typeof d.getTime ? b[a] = d.getTime() : (F(d) || G(d)) && c.datePropsToTimestamps(d)
            })
        };
        c.formatSingle = function(b, d, a) {
            var g = /\.([0-9])/,
                h = c.defaultOptions.lang;
            /f$/.test(b) ? (a = (a = b.match(g)) ? a[1] : -1, null !== d && (d = c.numberFormat(d, a, h.decimalPoint, -1 < b.indexOf(",") ? h.thousandsSep : ""))) : d = (a || c.time).dateFormat(b, d);
            return d
        };
        c.format = function(b, d, a) {
            for (var g = "{", h = !1, e, m, u, n, t = [], x; b;) {
                ...
                if (h) {
                    ...
                    e.length && (x = c.formatSingle(e.join(":"), x, a));
                    t.push(x)
                } else t.push(e);
                b = b.slice(g + 1);
                g = (h = !h) ? "}" : "{"
        ...
        c.normalizeTickInterval = function(b, d, a, g, h) {
            ...
            a = c.pick(a, 1);
            var m = b / a;
            d || (d = h ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === g && (1 === a ? d = d.filter(function(a) {
                return 0 === a % 1
            }) : .1 >= a && (d = [1 / a])));
            for (g = 0; g < d.length && !(e = d[g], h && e * a >= b || !h && m <= (d[g] + (d[g + 1] || d[g])) / 2); g++);
            return e = c.correctFloat(e * a, -Math.round(Math.log(.001) / Math.LN10))
        };
        c.stableSort = function(b, d) {
            var a = b.length,
                g, h;
            for (h = 0; h < a; h++) b[h].safeI = h;
            b.sort(function(a, b) {
                g = d(a, b);
                return 0 === g ? a.safeI - b.safeI : g
            });
            for (h = 0; h < a; h++) delete b[h].safeI
        };
        ...
        c.destroyObjectProperties = function(b, d) {
            D(b, function(a, g) {
        ...
        c.setAnimation = function(b, d) {
            d.renderer.globalAnimation = c.pick(b, d.options.chart.animation, !0)
        };
        ...
        c.numberFormat = function(b, d, a, g) {
            ...
            var h = c.defaultOptions.lang,
                e = (b.toString().split(".")[1] || "").split("e")[0].length,
            ...
            b += e.substr(u).replace(/(\d{3})(?=\d)/g, "$1" + g);
            d && (b += a + n.slice(-d));
            m[1] && 0 !== +b && (b += "e" + m[1]);
            return b
        };
        ...
        c.find = Array.prototype.find ?
            function(b, d) {
                ...
                var a, g = b.length;
                for (a = 0; a < g; a++) if (d(b[a], a)) return b[a]
            };
        c.keys = Object.keys;
        c.offset = function(b) {
        ...
        c.addEvent = function(b, d, a, g) {
            ...
            var e = "function" === typeof b && b.prototype ? b.prototype.protoEvents = b.prototype.protoEvents || {} : b.hcEvents = b.hcEvents || {};
        ...
        c.removeEvent = function(b, d, a) {
            ...
            function h(a) {
                ...
                if (b.nodeName) {
                    ...
                    D(h, function(b, d) {
                        if (a[d]) for (e = a[d].length; e--;) g(d, a[d][e].fn)
                    })
                }
            }
            var e;
            ["protoEvents", "hcEvents"].forEach(function(c) {
                var m = b[c];
                m && (d ? (e = m[d] || [], a ? (m[d] = e.filter(function(b) {
                    return a !== b.fn
                }), g(d, a)) : (h(m), m[d] = [])) : (h(m), b[c] = {}))
            })
        };
        c.fireEvent = function(b, d, a, g) {
            ...
            if (n.createEvent && (b.dispatchEvent || b.fireEvent)) {
                ...
                var g = 0,
                    c = 0,
                    m = d.length + e.length;
                for (h = 0; h < m; h++)!1 === (d[g] ? e[c] ? d[g].order <= e[c].order ? d[g++] : e[c++] : d[g++] : e[c++]).fn.call(b, a) && a.preventDefault()
        ...
        c.animate = function(b, d, a) {
            ...
            D(d, function(u, t) {
                ...
                m = new c.Fx(b, a, t);
                e = null;
                "d" === t ? (m.paths = m.initPath(b, b.d, d.d), m.toD = d.d, g = 0, e = 1) : b.attr ? g = b.attr(t) : (g = parseFloat(c.getStyle(b, t)) || 0, "opacity" !== t && (h = "px"));
                e || (e = u);
        ...
        c.seriesType = function(b, d, a, g, h) {
            var e = c.getOptions(),
                m = c.seriesTypes;
            e.plotOptions[b] = c.merge(e.plotOptions[d], a);
            m[b] = c.extendClass(m[d] ||
                function() {}, g);
        ...
        l.jQuery && (l.jQuery.fn.highcharts = function() {
            ...
            if (this[0]) return b[0] ? (new(c[y(b[0]) ? b.shift() : "Chart"])(this[0], b[0], b[1]), this) : w[c.attr(this[0], "data-highcharts-chart")]
        });
        return {
            defined: v,
            erase: function(b, d) {
                for (var a = b.length; a--;) if (b[a] === d) {
                    b.splice(a, 1);
                    break
                }
            },
    ...
    M(J, "parts/Color.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        c.Color.prototype = {
            ...
            init: function(z) {
                var r, p;
                if ((this.input = z = this.names[z && z.toLowerCase ? z.toLowerCase() : ""] || z) && z.stops) this.stops = z.stops.map(function(w) {
                    return new c.Color(w[1])
                });
                else {
                    if (z && z.charAt && "#" === z.charAt()) {
                        var v = z.length;
                        z = parseInt(z.substr(1), 16);
                        7 === v ? r = [(z & 16711680) >> 16, (z & 65280) >> 8, z & 255, 1] : 4 === v && (r = [(z & 3840) >> 4 | (z & 3840) >> 8, (z & 240) >> 4 | z & 240, (z & 15) << 4 | z & 15, 1])
                    }
                    if (!r) for (p = this.parsers.length; p-- && !r;) {
                        var y = this.parsers[p];
            ...
            get: function(c) {
                ...
                if (this.stops) {
                    ...
                    this.stops.forEach(function(r, w) {
                        v.stops[w] = [v.stops[w][0], r.get(c)]
                    })
                } else v = z && y(z[0]) ? "rgb" === c || !c && 1 === z[3] ? "rgb(" + z[0] + "," + z[1] + "," + z[2] + ")" : "a" === c ? z[3] : "rgba(" + z.join(",") + ")" : r;
                return v
            },
            brighten: function(c) {
                var r, z = this.rgba;
                ...
                else if (y(c) && 0 !== c) for (r = 0; 3 > r; r++) z[r] += G(255 * c), 0 > z[r] && (z[r] = 0), 255 < z[r] && (z[r] = 255);
                return this
            },
            ...
            tweenTo: function(c, r) {
                var z = this.rgba,
                    v = c.rgba;
                v.length && z && z.length ? (c = 1 !== v[3] || 1 !== z[3], r = (c ? "rgba(" : "rgb(") + Math.round(v[0] + (z[0] - v[0]) * (1 - r)) + "," + Math.round(v[1] + (z[1] - v[1]) * (1 - r)) + "," + Math.round(v[2] + (z[2] - v[2]) * (1 - r)) + (c ? "," + (v[3] + (z[3] - v[3]) * (1 - r)) : "") + ")") : r = c.input || "none";
                return r
            }
        };
        c.color = function(z) {
    ...
    M(J, "parts/SvgRenderer.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        E(L.prototype, {
            ...
            init: function(a, b) {
                this.element = "span" === b ? h(b) : u.createElementNS(this.SVG_NS, b);
                this.renderer = a;
            ...
            animate: function(a, b, f) {
                ...
                0 !== I.duration ? (f && (I.complete = f), l(this, a, I)) : (this.attr(a, void 0, f), v(a, function(a, b) {
                    I.step && I.step.call(this, a, {
                        prop: b,
                        pos: 1
                    })
                }, this));
            ...
            complexColor: function(a, b, f) {
                ...
                c.fireEvent(this.renderer, "complexColor", {
                    ...
                    d && (e = a[d], g = I.gradients, P = a.stops, C = f.radialReference, F(e) && (a[d] = e = {
                        x1: e[0],
                        y1: e[1],
                        x2: e[2],
                        y2: e[3],
                        gradientUnits: "userSpaceOnUse"
                    }), "radialGradient" === d && C && !y(e.gradientUnits) && (k = e, e = B(e, I.getRadialAttr(C, k), {
                        gradientUnits: "userSpaceOnUse"
                    })), v(e, function(a, I) {
                        "id" !== I && Q.push(I, a)
                    }), v(P, function(a) {
                        Q.push(a)
                    }), Q = Q.join(","), g[Q] ? N = g[Q].attr("id") : (e.id = N = c.uniqueKey(), g[Q] = h = I.createElement(d).attr(e).add(I.defs), h.radAttr = k, h.stops = [], P.forEach(function(a) {
                        ...
                        h.stops.push(a)
                    })), L = "url(" + I.url + "#" + N + ")", f.setAttribute(b, L), f.gradient = Q, a.toString = function() {
                        return L
                    })
                })
            },
            applyTextOutline: function(a) {
                ...
                if ((f = a[0]) && "none" !== f && c.svg) {
                    ...
                    f = f.replace(/(^[\d\.]+)(.*?)$/g, function(a, I, b) {
                        return 2 * I + b
                    });
                    this.removeTextOutline(a);
                    var d = I.firstChild;
                    a.forEach(function(a, e) {
                        0 === e && (a.setAttribute("x", I.getAttribute("x")), e = I.getAttribute("y"), a.setAttribute("y", e || 0), null === e && I.setAttribute("y", 0));
                        a = a.cloneNode(1);
                        b(a, {
            ...
            removeTextOutline: function(a) {
                for (var I = a.length, b; I--;) b = a[I], "highcharts-text-outline" === b.getAttribute("class") && G(a, this.element.removeChild(b))
            },
            ...
            attr: function(a, b, f, q) {
                ...
                "string" === typeof a ? e = (this[a + "Getter"] || this._defaultGetter).call(this, a, I) : (v(a, function(b, f) {
                    ...
                    g || (k = this[f + "Setter"] || this._defaultSetter, k.call(this, b, f, I), !this.styledMode && this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(f) && this.updateShadows(f, b, k))
            ...
            updateShadows: function(a, b, f) {
                for (var I = this.shadows, q = I.length; q--;) f.call(I[q], "height" === a ? Math.max(b - (I[q].cutHeight || 0), 0) : "d" === a ? this.d : b, a, I[q])
            },
            addClass: function(a, b) {
                var I = this.attr("class") || "";
                b || (a = (a || "").split(/ /g).reduce(function(a, b) {
                    -1 === I.indexOf(b) && a.push(b);
                    return a
                }, I ? [I] : []).join(" "));
            ...
            css: function(a) {
                ...
                if (e) {
                    ...
                    if (q.namespaceURI === this.SVG_NS) {
                        ...
                        v(a, function(a, b) {
                            -1 === k.indexOf(b) && (d += b.replace(/([A-Z])/g, h) + ":" + a + ";")
                        });
                        d && b(q, "style", d)
                    } else g(q, a);
            ...
            strokeWidth: function() {
                ...
                if (a.indexOf("px") === a.length - 2) a = D(a);
                else {
                    var f = u.createElementNS(T, "rect");
                    b(f, {
                        width: a,
                        "stroke-width": 0
                    });
            ...
            on: function(a, b) {
                var f = this,
                    q = f.element;
                t && "click" === a ? (q.ontouchstart = function(a) {
                    f.touchEventFired = Date.now();
                    a.preventDefault();
                    b.call(q, a)
                }, q.onclick = function(a) {
                    (-1 === S.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (f.touchEventFired || 0)) && b.call(q, a)
                }) : q["on" + a] = b;
                return this
            },
            ...
            updateTransform: function() {
                ...
                e ? a.push("rotate(90) scale(-1,1)") : k && a.push("rotate(" + k + " " + q(this.rotationOriginX, c.getAttribute("x"), 0) + " " + q(this.rotationOriginY, c.getAttribute("y") || 0) + ")");
            ...
            align: function(a, b, f) {
                ...
                var g, c;
                if (a) {
                    if (this.alignOptions = a, this.alignByTranslate = b, !f || K(f)) this.alignTo = d = f || "renderer", G(k, this), k.push(this), f = null
            ...
            getBBox: function(a, b) {
                ...
                if (y(g)) {
                    var C = g.toString(); - 1 === C.indexOf("<") && (C = C.replace(/[0-9]/g, "0"));
                    C += ["", b || 0, A, this.textWidth, k && k.textOverflow].join()
                }
                C && !a && (f = h[C]);
                if (!f) {
                    if (P || d.forExport) {
                        try {
                            (c = this.fakeTS &&
                                function(a) {
                                    [].forEach.call(I.querySelectorAll(".highcharts-text-outline"), function(b) {
                                        b.style.display = a
                                    })
                                }) && c("none"), f = I.getBBox ? E({}, I.getBBox()) : {
                                width: I.offsetWidth,
                    ...
                    d.isSVG && (a = f.width, d = f.height, P && (f.height = d = {
                        "11px,17": 14,
                        "13px,20": 16
                    }[k && k.fontSize + "," + Math.round(d)] || d), b && (f.width = Math.abs(d * Math.sin(m)) + Math.abs(a * Math.cos(m)), f.height = Math.abs(d * Math.cos(m)) + Math.abs(a * Math.sin(m))));
                    if (C && 0 < f.height) {
                        for (; 250 < B.length;) delete h[B.shift()];
                        h[C] || B.push(C);
                        h[C] = f
                    }
                }
            ...
            add: function(a) {
                ...
                this.added = !0;
                if (!a || a.handleZ || this.zIndex) var q = this.zIndexSetter();
                q || (a ? a.element : b.box).appendChild(f);
            ...
            destroy: function() {
                ...
                C(a);
                e && d && ([].forEach.call(d.querySelectorAll("[clip-path],[CLIP-PATH]"), function(a) {
                ...
                a.safeRemoveChild(b);
                for (f.styledMode || a.destroyShadows(); q && q.div && 0 === q.div.childNodes.length;) b = q.parentGroup, a.safeRemoveChild(q.div), delete q.div, q = b;
                a.alignTo && G(f.alignedObjects, a);
                v(a, function(b, f) {
                    a[f] && a[f].parentGroup === a && a[f].destroy && a[f].destroy();
                    delete a[f]
                })
            },
            ...
            _defaultGetter: function(a) {
                a = q(this[a + "Value"], this[a], this.element ? this.element.getAttribute(a) : null, 0);
                /^[\-0-9\.]+$/.test(a) && (a = parseFloat(a));
                return a
            },
            dSetter: function(a, b, f) {
                a && a.join && (a = a.join(" "));
            ...
            setTextPath: function(a, b) {
                ...
                if (a && b && b.enabled) {
                    ...
                    if (k) for (a = f.getElementsByTagName("tspan"); a.length;) a[0].setAttribute("y", 0), h.appendChild(a[0]);
                    d && e.add({
                ...
                } else e && (delete this.updateTransform, delete this.applyTextOutline, this.destroyTextPath(f, a));
                return this
            },
            destroyTextPath: function(a, b) {
                var f;
                b.element.setAttribute("id", "");
                for (f = this.textPathWrapper.element.childNodes; f.length;) a.firstChild.appendChild(f[0]);
                a.firstChild.removeChild(this.textPathWrapper.element);
                delete b.textPathWrapper
            },
            fillSetter: function(a, b, f) {
                "string" === typeof a ? f.setAttribute(b, a) : a && this.complexColor(a, b, f)
            },
            visibilitySetter: function(a, b, f) {
                "inherit" === a ? f.removeAttribute(b) : this[b] !== a && f.setAttribute(b, a);
                this[b] = a
            },
            zIndexSetter: function(a, b) {
                ...
                if (g) {
                    ...
                    for (c = b.length - 1; 0 <= c && !k; c--) {
                        ...
                        var h = !y(g);
                        if (q !== e) if (0 > a && h && !f && !c) d.insertBefore(e, b[c]), k = !0;
                        else if (D(g) <= a || h && (!y(a) || 0 <= a)) d.insertBefore(e, b[c + 1] || null), k = !0
                    }
                    k || (d.insertBefore(e, b[f ? 3 : 0] || null), k = !0)
                }
                return k
            },
            _defaultSetter: function(a, b, f) {
                f.setAttribute(b, a)
            }
        });
        ...
        L.prototype["stroke-widthSetter"] = L.prototype.strokeSetter = function(a, b, f) {
            this[b] = a;
        ...
        E(p.prototype, {
            ...
            init: function(a, f, q, d, e, k, c) {
                ...
                this.boxWrapper = h;
                this.alignedObjects = [];
                this.url = (x || A) && u.getElementsByTagName("base").length ? S.location.href.split("#")[0].replace(/<[^>]*>/g, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
                ...
                }, f(), this.unSubPixelFix = n(S, "resize", f))
            },
            definition: function(a) {
                function b(a, q) {
                    var d;
                    w(a).forEach(function(a) {
                        var e = f.createElement(a.tagName),
                            k = {};
                        v(a, function(a, b) {
            ...
            truncate: function(a, b, f, d, q, e, k) {
                var g = this,
                    c = a.rotation,
                    h, I = d ? 1 : 0,
                    B = (f || d).length,
                    ...
                    N = function(e, c) {
                        c = c || e;
                        if (void 0 === A[c]) if (b.getSubStringLength) try {
                            A[c] = q + b.getSubStringLength(0, d ? c + 1 : c)
                        } catch (ba) {
                            ""
                        } else g.getSpanWidth && (C(k(f || d, e)), A[c] = q + g.getSpanWidth(a, b));
                        return A[c]
                    },
                    L;
                a.rotation = 0;
                ...
                if (L = q + P > e) {
                    for (; I <= B;) m = Math.ceil((I + B) / 2), d && (h = k(d, m)), P = N(m, h && h.length - 1), I === B ? I = B + 1 : P > e ? B = m - 1 : I = m;
            ...
            buildText: function(a) {
                ...
                var E = function(a) {
                    ...
                    w = function(a, b) {
                        v(d.escapes, function(f, d) {
                            b && -1 !== b.indexOf(f) || (a = a.toString().replace(new RegExp(f, "g"), d))
                        });
                        return a
                    },
                    R = function(a, b) {
                        ...
                        f = a.indexOf(b + "=");
                        if (-1 !== f && (f = f + b.length + 1, b = a.charAt(f), '"' === b || "'" === b)) return a = a.substring(f + 1), a.substring(0, a.indexOf(b))
                    },
                    r = /<br.*?>/g;
                var S = [k, t, H, C, L, x, A].join();
                if (S !== a.textCache) {
                    for (a.textCache = S; l--;) f.removeChild(h[l]);
                    c || L || t || A || -1 !== k.indexOf(" ") && (!H || r.test(k)) ? (m && m.appendChild(f), c ? (k = d.styledMode ? k.replace(/<(b|strong)>/g, '<span class="highcharts-strong">').replace(/<(i|em)>/g, '<span class="highcharts-emphasized">') : k.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">'), k = k.replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(r)) : k = [k], k = k.filter(function(a) {
                        return "" !== a
                    }), k.forEach(function(q, k) {
                        var c = 0,
                            h = 0;
                        ...
                        m.forEach(function(q) {
                            if ("" !== q || 1 === m.length) {
                                ...
                                (l = R(q, "href")) && !e && (b(L, "onclick", 'location.href="' + l + '"'), b(L, "class", "highcharts-anchor"), d.styledMode || g(L, {
                                    cursor: "pointer"
                                }));
                                ...
                                if (" " !== q) {
                                    ...
                                    if (A) {
                                        ...
                                        l = 0;
                                        var r = E(L);
                                        if (t) B = d.truncate(a, L, q, void 0, 0, Math.max(0, A - parseInt(x || 12, 10)), function(a, b) {
                                            return a.substring(0, b) + "\u2026"
                                        });
                                        else if (C) for (; Q.length;) Q.length && !H && 0 < l && (L = u.createElementNS(T, "tspan"), b(L, {
                                            dy: r,
                                            x: I
                                        }), P && b(L, "style", P), L.appendChild(u.createTextNode(Q.join(" ").replace(/- /g, "-"))), f.appendChild(L)), d.truncate(a, L, null, Q, 0 === l ? h : 0, A, function(a, b) {
            ...
            button: function(a, b, f, d, q, e, g, c, h, m) {
                ...
                n(I.element, k ? "mouseover" : "mouseenter", function() {
                    3 !== A && I.setState(1)
                });
                n(I.element, k ? "mouseout" : "mouseleave", function() {
                    3 !== A && I.setState(A)
                });
            ...
            circle: function(a, b, f) {
                ...
                b.xSetter = b.ySetter = function(a, b, f) {
                    f.setAttribute("c" + b, a)
                };
                return b.attr(a)
            },
                ...
                if (I) {
                    ...
                    ["width", "height"].forEach(function(a) {
                        L[a + "Setter"] = function(a, b) {
                            ...
                            this[b] = a;
                            y(q) && (c && "within" === c.backgroundSize && this.width && this.height && (q = Math.round(q * Math.min(this.width / this.imgwidth, this.height / this.imgheight))), this.element && this.element.setAttribute(b, q), this.alignByTranslate || (f[d] = ((this[b] || 0) - q) / 2, this.attr(f)))
                        }
                    });
                    y(b) && L.attr({
                        x: b,
                    ...
                    L.isImg = !0;
                    y(L.imgwidth) && y(L.imgheight) ? H() : (L.attr({
                        width: 0,
                        height: 0
                    }), h("img", {
                        onload: function() {
            ...
            symbols: {
                circle: function(a, b, f, q) {
                    return this.arc(a + f / 2, b + q / 2, f / 2, q / 2, {
                        start: .5 * Math.PI,
                        end: 2.5 * Math.PI,
                        open: !1
                    })
                },
                square: function(a, b, f, q) {
                    return ["M", a, b, "L", a + f, b, a + f, b + q, a, b + q, "Z"]
                },
                triangle: function(a, b, f, q) {
                    return ["M", a + f / 2, b, "L", a + f, b + q, a, b + q, "Z"]
                },
                "triangle-down": function(a, b, f, q) {
                    return ["M", a, b, "L", a + f, b, a + f / 2, b + q, "Z"]
                },
                diamond: function(a, b, f, q) {
                    return ["M", a + f / 2, b, "L", a + f, b + q / 2, a + f / 2, b + q, a, b + q / 2, "Z"]
                },
                arc: function(a, b, f, d, e) {
                    var k = e.start,
                        g = e.r || f,
                        c = e.r || d || f,
                        h = e.end - .001;
                    f = e.innerR;
                    d = q(e.open, .001 > Math.abs(e.end - e.start - 2 * Math.PI));
                    var m = Math.cos(k),
                        B = Math.sin(k),
                        A = Math.cos(h);
                    h = Math.sin(h);
                ...
                callout: function(a, b, f, q, d) {
                    var e = Math.min(d && d.r || 0, f, q),
                        ...
                        g = d && d.anchorX;
                    d = d && d.anchorY;
                    var c = ["M", a + e, b, "L", a + f - e, b, "C", a + f, b, a + f, b, a + f, b + e, "L", a + f, b + q - e, "C", a + f, b + q, a + f, b + q, a + f - e, b + q, "L", a + e, b + q, "C", a, b + q, a, b + q, a, b + q - e, "L", a, b + e, "C", a, b, a, b, a + e, b];
            ...
            text: function(a, b, f, q) {
                ...
                q || (a.xSetter = function(a, b, f) {
                    ...
                    for (e = 0; e < q.length; e++) {
                        var k = q[e];
                        k.getAttribute(b) === d && k.setAttribute(b, a)
                    }
                    f.setAttribute(b, a)
                });
                return a
            ...
            fontMetrics: function(a, b) {
                a = !this.styledMode && /px/.test(a) || !S.getComputedStyle ? a || b && b.style && b.style.fontSize || this.style && this.style.fontSize : b && L.prototype.getStyle.call(b, "font-size");
                a = /px/.test(a) ? D(a) : 12;
            ...
            rotCorr: function(a, b, f) {
                var q = a;
                b && f && (q = Math.max(q * Math.cos(b * e), 4));
                return {
                    x: -a / 3 * Math.sin(b * e),
                    y: q
                }
            ...
            label: function(a, b, q, d, e, k, g, c, h) {
                var m = this,
                    A = m.styledMode,
                    C = m.g("button" !== h && "label"),
                    N = C.text = m.text("", 0, 0, g).attr({
                        zIndex: 1
                    }),
                    t, H, u = 0,
                    x = 3,
                    ...
                    v = A || S,
                    p = function() {
                        return A ? t.strokeWidth() % 2 / 2 : (R ? parseInt(R, 10) : 0) % 2 / 2
                    };
                ...
                var K = function() {
                    ...
                    v && (t || (C.box = t = m.symbols[d] || S ? m.symbol(d) : m.rect(), t.addClass(("button" === h ? "" : "highcharts-label-box") + (h ? " highcharts-" + h + "-box" : "")), t.add(C), a = p(), b.x = a, b.y = (c ? -r : 0) + a), b.width = Math.round(C.width), b.height = Math.round(C.height), t.attr(E(b, Q)), Q = {})
                };
                var D = function() {
                    var a = n + x;
                    var b = c ? 0 : r;
                    y(I) && H && ("center" === w || "right" === w) && (a += {
                        center: .5,
                        right: 1
                    }[w] * (I - H.width));
                    if (a !== N.x || b !== N.y) N.attr("x", a), N.hasBoxWidthChanged && (H = N.getBBox(!0), K()), void 0 !== b && N.attr("y", b);
                    N.x = a;
                    N.y = b
                };
                var V = function(a, b) {
    ...
    M(J, "parts/Html.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        K(l.prototype, {
                ...
                if (this.added) {
                    ...
                    if ("SPAN" === a.tagName) {
                        ...
                        var k = this.textWidth && G(this.textWidth),
                            ...
                            B;
                        (B = k !== this.oldTextWidth) && !(B = k > this.oldTextWidth) && ((B = this.textPxLength) || (r(a, {
                            width: "",
                            whiteSpace: x || "nowrap"
            ...
            getSpanCorrection: function(b, a, g) {
                this.xCorr = -b * g;
                this.yCorr = -a
            }
        });
        K(p.prototype, {
            getTransformKey: function() {
                return D && !/Edge/.test(b.navigator.userAgent) ? "-ms-transform" : w ? "-webkit-transform" : v ? "MozTransform" : b.opera ? "-o-transform" : ""
            },
            html: function(b, a, g) {
                var d = this.createElement("span"),
                    ...
                    E = function(a, b) {
                        ["opacity", "visibility"].forEach(function(d) {
                            a[d + "Setter"] = function(e, k, q) {
                                var f = a.div ? a.div.style : b;
                    ...
                    if (this.parentGroup = a) {
                        ...
                        if (!c) {
                            ...
                            g.reverse().forEach(function(a) {
                                function q(b, f) {
                                    a[f] = b;
                                    "translateX" === f ? e.left = b + "px" : e.top = b + "px";
                                    a.doTransform = !0
                                }
    ...
    M(J, "parts/Time.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        c.Time.prototype = {
            ...
            update: function(c) {
                ...
                (this.variableTimezone = !(n && !c.getTimezoneOffset && !c.timezone)) || this.timezoneOffset ? (this.get = function(d, a) {
                    var g = a.getTime(),
                    ...
                    a.setTime(g);
                    return d
                }, this.set = function(d, a, g) {
                    if ("Milliseconds" === d || "Seconds" === d || "Minutes" === d && 0 === a.getTimezoneOffset() % 60) a["set" + d](g);
                    else {
                        var c = b.getTimezoneOffset(a);
                        c = a.getTime() - c;
                        a.setTime(c);
                        a["setUTC" + d](g);
                ...
                }) : n ? (this.get = function(b, a) {
                    return a["getUTC" + b]()
                }, this.set = function(b, a, c) {
                    return a["setUTC" + b](c)
            ...
            makeTime: function(n, l, b, d, a, g) {
                if (this.useUTC) {
                    var h = this.Date.UTC.apply(0, arguments);
                    var e = this.getTimezoneOffset(h);
                    h += e;
                    var m = this.getTimezoneOffset(h);
                    e !== m ? h += m - e : e - 36E5 !== this.getTimezoneOffset(h - 36E5) || c.isSafari || (h -= 36E5)
                } else h = (new this.Date(n, l, v(b, 1), v(d, 0), v(a, 0), v(g, 0))).getTime();
                return h
            },
            timezoneOffsetFunction: function() {
                ...
                if (l.timezone) {
                    if (b) return function(d) {
                        return 6E4 * -b.tz(d, l.timezone).utcOffset()
                    };
                    c.error(25)
                }
                return this.useUTC && l.getTimezoneOffset ?
                    function(b) {
                        return 6E4 * l.getTimezoneOffset(b)
                    } : function() {
            ...
            dateFormat: function(n, l, b) {
                ...
                a = c.extend({
                    ...
                    P: 12 > g ? "am" : "pm",
                    S: k(a.getSeconds()),
                    L: k(Math.floor(l % 1E3), 3)
                }, c.dateFormats);
                F(a, function(a, b) {
                    for (; - 1 !== n.indexOf("%" + b);) n = n.replace("%" + b, "function" === typeof a ? a.call(d, l) : a)
                });
                return b ? n.substr(0, 1).toUpperCase() + n.substr(1) : n
            },
            resolveDTLFormat: function(c) {
                return G(c, !0) ? c : (c = z(c), {
                    main: c[0],
                    from: c[1],
                    to: c[2]
                })
            ...
            getTimeTicks: function(c, l, b, d) {
                ...
                if (y(l)) {
                    ...
                    m >= D.minute && a.set("Minutes", e, m >= D.hour ? 0 : u * Math.floor(a.get("Minutes", e) / u));
                    ...
                    if (m >= D.month) {
                        a.set("Month", e, m >= D.year ? 0 : u * Math.floor(a.get("Month", e) / u));
                        var t = a.get("FullYear", e)
                    }
                    m >= D.year && a.set("FullYear", e, t - t % u);
                    ...
                    g.push(l);
                    m <= D.hour && 1E4 > g.length && g.forEach(function(b) {
    ...
    M(J, "parts/Options.js", [J["parts/Globals.js"]], function(c) {
        ...
        c.setOptions = function(p) {
            c.defaultOptions = y(!0, c.defaultOptions, p);
        ...
        c.dateFormat = function(p, y, z) {
            return c.time.dateFormat(p, y, z)
        };
        ""
    });
    M(J, "parts/Tick.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        c.Tick.prototype = {
            addLabel: function() {
                ...
                e = e.info;
                var t, x;
                if (n.isDatetimeAxis && e) {
                    var k = b.time.resolveDTLFormat(l.dateTimeLabelFormats[!l.grid && e.higherRanks[g] || e.unitName]);
                    var A = k.main
                }
                w.isFirst = m;
                w.isLast = u;
                w.formatCtx = {
                    ...
                    tickPositionInfo: e,
                    value: n.isLog ? F(n.lin2log(d)) : d,
                    pos: g
                };
                l = n.labelFormatter.call(w.formatCtx, this.formatCtx);
                if (x = k && k.list) w.shortenLabel = function() {
                    for (t = 0; t < x.length; t++) if (E.attr({
                        text: n.labelFormatter.call(c.extend(w.formatCtx, {
                            dateTimeLabelFormat: x[t]
                        }))
                    }), E.getBBox().width < n.getSlotWidth(w) - 2 * v(h.padding, 5)) return;
                    E.attr({
                        text: ""
                    })
                };
                if (y(E)) E && E.textStr !== l && (!E.textWidth || h.style && h.style.width || E.styles.width || E.css({
                    width: null
                }), E.attr({
                    text: l
                }), E.textPxLength = E.getBBox().width);
                else {
                    if (w.label = E = y(l) && h.enabled ? b.renderer.text(l, 0, 0, h.useHTML).add(n.labelGroup) : null) b.styledMode || E.css(K(h.style)), E.textPxLength = E.getBBox().width;
                    w.rotation = 0
                }
            },
            ...
            getPosition: function(w, n, l, b) {
                var d = this.axis,
                    a = d.chart,
                    g = b && a.oldChartHeight || a.chartHeight;
                w = {
                    x: w ? c.correctFloat(d.translate(n + l, null, null, b) + d.transB) : d.left + d.offset + (d.opposite ? (b && a.oldChartWidth || a.chartWidth) - d.right - d.left : 0),
                    y: w ? g - d.bottom + d.offset - (d.opposite ? d.height : 0) : c.correctFloat(g - d.translate(n + l, null, null, b) - d.transB)
                };
            ...
            getMarkPath: function(c, n, l, b, d, a) {
                return a.crispLine(["M", c, n, "L", c + (d ? 0 : -l), n + (d ? l : 0)], b)
            },
            renderGridLine: function(c, n, l) {
                ...
                if (a && (l = b.getPlotLinePath({
                    value: h + m,
                    lineWidth: a.strokeWidth() * l,
                    force: "pass",
                    old: c
            ...
            renderMark: function(c, n, l) {
                ...
                d = d[h + "Color"];
                e && (b.opposite && (e[0] = -e[0]), u && (this.mark = m = a.path().addClass("highcharts-" + (g ? g + "-" : "") + "tick").add(b.axisGroup), b.chart.styledMode || m.attr({
                    stroke: d,
                    "stroke-width": t
                })), m[u ? "attr" : "animate"]({
                    d: this.getMarkPath(E, c, e[0], m.strokeWidth() * l, b.horiz, a),
                    opacity: n
                }))
            },
            renderLabel: function(c, n, l, b) {
                ...
                var u = !0,
                    E = c.x;
                c = c.y;
                h && G(E) && (h.xy = c = this.getLabelPosition(E, c, h, a, e, d, b, m), this.isFirst && !this.isLast && !v(g.showFirstLabel, 1) || this.isLast && !this.isFirst && !v(g.showLastLabel, 1) ? u = !1 : !a || e.step || e.rotation || n || 0 === l || this.handleOverflow(c), m && b % m && (u = !1), u && G(c.y) ? (c.opacity = l, h[this.isNewLabel ? "attr" : "animate"](c), this.isNewLabel = !1) : (h.attr("y", -9999), this.isNewLabel = !0))
            },
            render: function(r, n, l) {
                var b = this.axis,
                    d = b.horiz,
                    a = this.pos,
    ...
    M(J, "parts/Axis.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        c.extend(p.prototype, {
            ...
            init: function(a, b) {
                ...
                b = q.options.events; - 1 === a.axes.indexOf(q) && (f ? a.axes.splice(a.xAxis.length, 0, q) : a.axes.push(q), a[q.coll].push(q));
                q.series = q.series || [];
                a.inverted && !q.isZAxis && f && void 0 === q.reversed && (q.reversed = !0);
                r(b, function(a, b) {
                    c.isFunction(a) && v(q, b, a)
                });
            ...
            setOptions: function(a) {
                this.options = E(this.defaultOptions, "yAxis" === this.coll && this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], E(d[this.coll], a));
            ...
            defaultLabelFormatter: function() {
                ...
                else if (A && 1E3 <= a) for (; A-- && void 0 === u;) e = Math.pow(h, A + 1), a >= e && 0 === 10 * b % e && null !== B[A] && 0 !== b && (u = c.numberFormat(b / e, -1) + B[A]);
            ...
            translate: function(a, b, d, e, c, k) {
                ...
                b ? (a = (a * q + g - m) / h + e, c && (a = f.lin2val(a))) : (c && (a = f.val2lin(a)), a = F(e) ? q * (a - e) * h + g + q * m + (F(k) ? h * k : 0) : void 0);
                return a
            },
            ...
            getPlotLinePath: function(a) {
                var b = this,
                    ...
                    E, r = b.transB,
                    w = function(a, b, f) {
                        if ("pass" !== B && a < b || a > f) B ? a = Math.min(Math.max(b, a), f) : E = !0;
                        return a
                    };
                a = {
                    value: g,
            ...
            getLinearTickPositions: function(a, f, d) {
                var q = b(Math.floor(f / a) * a);
                d = b(Math.ceil(d / a) * a);
                var e = [],
                    c;
                b(q + a) === q && (c = 20);
            ...
            getMinorTickPositions: function() {
                ...
                k = a.max + k;
                var h = k - g;
                if (h && h / e < a.len / 3) if (a.isLog) this.paddedTicks.forEach(function(b, f, d) {
                    f && c.push.apply(c, a.getLogTickPositions(e, d[f - 1], d[f], !0))
                });
                ...
                else for (b = g + (d[0] - g) % e; b <= k && b !== c[0]; b += e) c.push(b);
            ...
            adjustForMinRange: function() {
                ...
                this.isXAxis && void 0 === this.minRange && !this.isLog && (y(a.min) || y(a.max) ? this.minRange = null : (this.series.forEach(function(a) {
                    g = a.xData;
                    for (c = h = a.xIncrement ? 1 : g.length - 1; 0 < c; c--) if (k = g[c] - g[c - 1], void 0 === e || k < e) e = k
            ...
            getClosest: function() {
                ...
                this.categories ? a = 1 : this.series.forEach(function(b) {
                    ...
                    !b.noSharedTooltip && y(f) && d && (a = y(a) ? Math.min(a, f) : f)
                });
                return a
            },
            nameToX: function(a) {
                var b = G(this.categories),
                    d = b ? this.categories : this.names,
                    e = a.options.x;
                a.series.requireSorting = !1;
                y(e) || (e = !1 === this.options.uniqueNames ? a.series.autoIncrement() : b ? d.indexOf(a.name) : x(d.keys[a.name], -1));
                if (-1 === e) {
                    if (!b) var q = d.length
                } else q = e;
                void 0 !== q && (this.names[q] = a.name, this.names.keys[a.name] = q);
                return q
            },
            updateNames: function() {
                ...
                0 < b.length && (Object.keys(b.keys).forEach(function(a) {
                    ...
                    b.data.forEach(function(f, d) {
                        if (f && f.options && void 0 !== f.name) {
                            var e = a.nameToX(f);
            ...
            setAxisTranslation: function(a) {
                ...
                if (B || h || q) {
                    ...
                    g ? (c = g.minPointOffset, k = g.pointRangePadding) : b.series.forEach(function(a) {
                        var f = h ? 1 : B ? x(a.options.pointRange, t, 0) : b.axisPointRange || 0,
            ...
            setTickInterval: function(a) {
                ...
                if (m) {
                    ...
                    if (!r && y(E)) if (f.dataMin >= E) z = E, A = 0;
                    else if (f.dataMax <= E) {
                        var p = E;
                        B = 0
                    }
                    f.min = x(w, z, f.dataMin);
                    f.max = x(v, p, f.dataMax)
                }
                k && (f.positiveValuesOnly && !a && 0 >= Math.min(f.min, x(f.dataMin, f.min)) && c.error(10, 1, d), f.min = b(f.log2lin(f.min), 15), f.max = b(f.log2lin(f.max), 15));
                ...
                r && y(f.dataMin) && (E = E || 0, !y(w) && f.min < E && f.dataMin >= E ? f.min = f.options.minRange ? Math.min(E, f.max - f.minRange) : E : !y(v) && f.max > E && f.dataMax <= E && (f.max = f.options.minRange ? Math.max(E, f.min + f.minRange) : E));
                ...
                h && !a && f.series.forEach(function(a) {
            ...
            setTickPositions: function() {
                ...
                !d && (!this.ordinalPositions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200) ? (d = [this.min, this.max], c.error(19, !1, this.chart)) : d = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, a.units), this.min, this.max, a.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max), d.length > this.len && (d = [d[0], d.pop()], d[0] === d[1] && (d.length = 1)), this.tickPositions = d, k && (k = k.apply(this, [this.min, this.max]))) && (this.tickPositions = d = k);
            ...
            trimTicks: function(a, b, d) {
                ...
                if (!this.isLinked) {
                    ...
                    else for (; this.min - c > a[0];) a.shift();
                    if (d) this.max = q;
                    else for (; this.max + c < a[a.length - 1];) a.pop();
            ...
            adjustTickAmount: function() {
                ...
                if (this.hasData()) {
                    if (g < c) {
                        for (m = this.min; e.length < c;) e.length % 2 || m === h ? e.push(b(e[e.length - 1] + d)) : e.unshift(b(e[0] - d));
                        this.transA *= (g - 1) / (c - 1);
                    ...
                    if (y(k)) {
                        for (d = a = e.length; d--;)(3 === k && 1 === d % 2 || 2 >= k && 0 < d && d < a - 1) && e.splice(d, 1);
            ...
            zoom: function(a, b) {
                ...
                e(this, "zoom", a, function(a) {
                    var b = a.newMin,
                        e = a.newMax;
                    if (b !== this.min || e !== this.max) this.allowZoomOutside || (y(d) && (b < q && (b = q), b > k && (b = k)), y(f) && (e < q && (e = q), e > k && (e = k))), this.displayBtn = void 0 !== b || void 0 !== e, this.setExtremes(b, e, !1, void 0, {
                        trigger: "zoom"
                    });
                    a.zoomed = !0
                });
            ...
            setAxisSize: function() {
                ...
                b = this.left = Math.round(c.relativeLength(x(b.left, a.plotLeft + d[3]), a.plotWidth, a.plotLeft));
            ...
            getExtremes: function() {
                var a = this.isLog;
                return {
                    min: a ? b(this.lin2log(this.min)) : this.min,
                    max: a ? b(this.lin2log(this.max)) : this.max,
            ...
            autoLabelAlign: function(a) {
                var b = (x(a, 0) - 90 * this.side + 720) % 360;
                a = {
                    align: "center"
                };
            ...
            tickSize: function(a) {
                var b = this.options,
                    d = b[a + "Length"],
                    c = x(b[a + "Width"], "tick" === a && this.isXAxis && !this.categories ? 1 : 0);
                if (c && d) {
            ...
            unsquish: function() {
                var d = this.options.labels,
                    ...
                    H = function(a) {
                        var d = a / (k || 1);
                        d = 1 < d ? Math.ceil(d) : 1;
                        d * e > u && Infinity !== a && Infinity !== k && (d = Math.ceil(u / e));
                        return b(d * e)
                    };
                f ? (t = !d.staggerLines && !d.step && (y(h) ? [h] : k < x(d.autoRotationLimit, 80) && d.autoRotation)) && t.forEach(function(b) {
                    if (b === h || b && -90 <= b && 90 >= b) {
                        B = H(Math.abs(m.h / Math.sin(a * b)));
            ...
            getSlotWidth: function(a) {
                var b = this.chart,
                    ...
                    k = b.margin[3];
                return a && a.slotWidth || d && 2 > (e.step || 0) && !e.rotation && (this.staggerLines || 1) * this.len / c || !d && (e.style && parseInt(e.style.width, 10) || k && k - b.spacing[3] || .33 * b.chartWidth)
            },
            renderUnsquish: function() {
                ...
                d.forEach(function(a) {
                    (a = e[a]) && a.label && a.label.textPxLength > u && (u = a.label.textPxLength)
                });
                ...
                if (this.autoRotation) u > m && u > A.h ? B.rotation = this.labelRotation : this.labelRotation = 0;
                    ...
                    if (!t) {
                        ...
                        for (m = d.length; !g && m--;) {
                            var x = d[m];
                            if (x = e[x].label) x.styles && "ellipsis" === x.styles.textOverflow ? x.css({
                                textOverflow: "clip"
                            }) : x.textPxLength > h && x.css({
                                width: h + "px"
                            }), x.getBBox().height > this.len / d.length - (A.h - A.f) && (x.specificTextOverflow = "ellipsis")
                        }
                    }
                }
                B.rotation && (H = u > .5 * a.chartHeight ? .33 * a.chartHeight : u, t || (n = "ellipsis"));
                if (this.labelAlign = c.align || this.autoLabelAlign(this.labelRotation)) B.align = this.labelAlign;
                d.forEach(function(a) {
                    var b = (a = e[a]) && a.label,
                        d = k.width,
                        f = {};
                    b && (b.attr(B), a.shortenLabel ? a.shortenLabel() : H && !d && "nowrap" !== k.whiteSpace && (H < b.textPxLength || "SPAN" === b.element.tagName) ? (f.width = H, t || (f.textOverflow = b.specificTextOverflow || n), b.css(f)) : b.styles && b.styles.width && !f.width && !d && b.css({
                        width: null
            ...
            addTitle: function(a) {
                ...
                this.axisTitle || ((k = c.textAlign) || (k = (d ? {
                    low: "left",
                    middle: "center",
                    high: "right"
                } : {
                    ...
                    align: k
                }).addClass("highcharts-axis-title"), g || this.axisTitle.css(E(c.style)), this.axisTitle.add(this.axisGroup), this.axisTitle.isNew = !0);
                g || c.style.width || this.isRadial || this.axisTitle.css({
                    width: this.len
                });
            ...
            getOffset: function() {
                ...
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (z || "")).add(v), a.axisGroup = d.g("axis").attr({
                    zIndex: c.zIndex || 2
                }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (z || "")).add(v), a.labelGroup = d.g("axis-labels").attr({
                    zIndex: n.zIndex || 7
                }).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (z || "")).add(v));
                p || a.isLinked ? (k.forEach(function(b, d) {
                    a.generateTick(b, d)
                }), a.renderUnsquish(), a.reserveSpaceDefault = 0 === m || 2 === m || {
                    1: "left",
                    3: "right"
                }[m] === a.labelAlign, x(n.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && k.forEach(function(a) {
                    l = Math.max(g[a].getLabelSize(), l)
                }), a.staggerLines && (l *= a.staggerLines), a.labelOffset = l * (a.opposite ? -1 : 1)) : r(g, function(a, b) {
                    a.destroy();
                    delete g[b]
                });
                if (H && H.text && !1 !== H.enabled && (a.addTitle(A), A && !1 !== H.reserveSpace)) {
                    a.titleOffset = t = a.axisTitle.getBBox()[h ? "height" : "width"];
                    var K = H.offset;
                ...
                E[m] = Math.max(E[m], a.axisTitleMargin + t + w * a.offset, u, k && k.length && h ? h[0] + w * a.offset : 0);
            ...
            getLinePath: function(a) {
                ...
                d && (a *= -1);
                return b.renderer.crispLine(["M", c ? this.left : k, c ? e : this.top, "L", c ? b.chartWidth - this.right : k, c ? e : b.chartHeight - this.bottom], a)
            },
            renderLine: function() {
            ...
            getTitlePosition: function() {
                ...
                a = {
                    x: a ? c + B : b + (h ? this.width : 0) + m + B,
                    y: a ? b + A - (h ? this.height : 0) + m : c + A
                };
            ...
            renderTick: function(a, b) {
                ...
                if (!d || a >= this.min && a <= this.max) e[a] || (e[a] = new H(this, a)), c && e[a].isNew && e[a].render(b, !0, -1), e[a].render(b)
            },
            render: function() {
                var a = this,
                    b = a.chart,
                ...
                if (a.hasData() || g) a.minorTickInterval && !a.categories && a.getMinorTickPositions().forEach(function(b) {
                    a.renderMinorTick(b)
                }), h.length && (h.forEach(function(b, d) {
                    a.renderTick(b, d)
                }), l && (0 === a.min || a.single) && (A[-1] || (A[-1] = new H(a, -1, null, !0)), A[-1].render(-1))), x && h.forEach(function(d, e) {
                    p = void 0 !== h[e + 1] ? h[e + 1] + l : a.max - l;
                    0 === e % 2 && d < a.max && p <= a.max + (b.polar ? -l : l) && (u[d] || (u[d] = new c.PlotLineOrBand(a)), v = d + l, u[d].options = {
                        from: k ? a.lin2log(v) : v,
                        to: k ? a.lin2log(p) : p,
                        color: x
            ...
            drawCrosshair: function(a, b) {
                ...
                if (this.crosshair && !1 !== (y(b) || !k)) {
                    k ? y(b) && (f = x(b.crosshairPos, this.isXAxis ? b.plotX : this.len - b.plotY)) : f = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos);
                    y(f) && (d = this.getPlotLinePath({
                        value: b && (this.isXAxis ? b.x : x(b.stackY, b.y)),
                        translatedValue: f
                    }) || null);
                    if (!y(d)) {
                        this.hideCrosshair();
                    ...
                    g || (this.cross = g = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (k ? "category " : "thin ") + c.className).attr({
                        zIndex: x(c.zIndex, 2)
                    }).add(), this.chart.styledMode || (g.attr({
                        stroke: c.color || (k ? l("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
    ...
    M(J, "parts/DateTimeAxis.js", [J["parts/Globals.js"]], function(c) {
        var p = c.Axis,
            ...
            F = c.timeUnits;
        p.prototype.getTimeTicks = function() {
        ...
        p.prototype.normalizeTimeTickInterval = function(c, r) {
            ...
            var v = F[r[0]],
                p = r[1],
                w;
            for (w = 0; w < z.length && !(r = z[w], v = F[r[0]], p = r[1], z[w + 1] && c <= (v * p[p.length - 1] + F[z[w + 1][0]]) / 2); w++);
    ...
    M(J, "parts/LogarithmicAxis.js", [J["parts/Globals.js"]], function(c) {
        ...
        p.prototype.getLogTickPositions = function(c, r, p, v) {
            ...
            if (.5 <= c) c = Math.round(c), n = this.getLinearTickPositions(c, r, p);
                ...
                w = Math.floor(r);
                var l, b;
                for (z = .3 < c ? [1, 2, 4] : .15 < c ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; w < p + 1 && !b; w++) {
                    var d = z.length;
                    for (l = 0; l < d && !b; l++) {
                        var a = this.log2lin(this.lin2log(w) * z[l]);
                        a > r && (!v || g <= p) && void 0 !== g && n.push(g);
                        g > p && (b = !0);
                        var g = a
                    }
                }
            } else r = this.lin2log(r), p = this.lin2log(p), c = v ? this.getMinorTickInterval() : z.tickInterval, c = F("auto" === c ? null : c, this._minorAutoInterval, z.tickPixelInterval / (v ? 5 : 1) * (p - r) / ((v ? w / this.tickPositions.length : w) || 1)), c = G(c, null, y(c)), n = this.getLinearTickPositions(c, r, p).map(this.log2lin), v || (this._minorAutoInterval = c / 5);
            v || (this.tickInterval = c);
            return n
        };
        p.prototype.log2lin = function(c) {
            return Math.log(c) / Math.LN10
        };
        p.prototype.lin2log = function(c) {
    ...
    M(J, "parts/PlotLineOrBand.js", [J["parts/Globals.js"], J["parts/Axis.js"], J["parts/Utilities.js"]], function(c, p, y) {
        ...
        c.PlotLineOrBand.prototype = {
            render: function() {
                ...
                l.chart.styledMode || (E ? (k.stroke = A || "#999999", k["stroke-width"] = w(d.width, 1), d.dashStyle && (k.dashstyle = d.dashStyle)) : u && (k.fill = A || "#e6ebf5", d.borderWidth && (k.stroke = d.borderColor, k["stroke-width"] = d.borderWidth)));
                q.zIndex = B;
                C += "-" + B;
                (A = l.plotLinesAndBandsGroups[C]) || (l.plotLinesAndBandsGroups[C] = A = f.g("plot-" + C).attr(q).add());
                x && (n.svgElem = t = f.path().attr(k).add(A));
                if (E) k = l.getPlotLinePath({
                    value: m,
                ...
                (x || !t.d) && k && k.length ? (t.attr({
                    d: k
                }), H && z(H, function(a, b) {
                    t.on(b, function(a) {
                        H[b].apply(n, [a])
                    })
                })) : t && (k ? (t.show(!0), t.animate({
                    d: k
                })) : t.d && (t.hide(), g && (n.label = g = g.destroy())));
                a && (G(a.text) || G(a.formatter)) && k && k.length && 0 < l.width && 0 < l.height && !k.isFlat ? (a = D({
                    align: b && u && "center",
                    x: b ? !u && 4 : 10,
                    verticalAlign: !b && u && "middle",
                    y: b ? u ? 16 : 10 : u ? 6 : -4,
                    rotation: b && !u && 90
                }, a), this.renderLabel(a, k, u, B)) : g && g.hide();
                return n
            },
        ...
        c.extend(p.prototype, {
            getPlotBandPath: function(c, l) {
                ...
                if (d && b) {
                    if (c) {
                        var e = d.toString() === b.toString();
                        h = 0
                    }
                    for (c = 0; c < d.length; c += 6) g && b[c + 1] === d[c + 1] ? (b[c + 1] += h, b[c + 4] += h) : g || b[c + 2] !== d[c + 2] || (b[c + 2] += h, b[c + 5] += h), a.push("M", d[c + 1], d[c + 2], "L", d[c + 4], d[c + 5], b[c + 4], b[c + 5], b[c + 1], b[c + 2], "z"), a.isFlat = e
                }
                return a
            },
            ...
            addPlotBandOrLine: function(n, l) {
                var b = (new c.PlotLineOrBand(this, n)).render(),
                    d = this.userOptions;
                b && (l && (d[l] = d[l] || [], d[l].push(n)), this.plotLinesAndBands.push(b));
                return b
            },
        ...
        c.Tooltip.prototype = {
            ...
            getLabel: function() {
                ...
                if (!this.label) {
                    this.outside && (this.container = e = c.doc.createElement("div"), e.className = "highcharts-tooltip-container", c.css(e, {
                        position: "absolute",
                        top: "1px",
                        pointerEvents: g.style && g.style.pointerEvents,
                        zIndex: 3
                    }), c.doc.body.appendChild(e), this.renderer = d = new c.Renderer(e, 0, 0));
                    this.split ? this.label = d.g(h) : (this.label = d.label("", 0, 0, g.shape || "callout", null, null, g.useHTML, null, h).attr({
                        padding: g.padding,
                        r: g.borderRadius
                    }), a || this.label.attr({
                    ...
                    if (this.outside) {
                        ...
                        this.label.xSetter = function(a, d) {
                            m[d].call(this.label, b.distance);
                            e.style.left = a + "px"
                        };
            ...
            move: function(b, d, a, g) {
                ...
                K(e, {
                    ...
                    anchorY: u ? void 0 : m ? (e.anchorY + g) / 2 : g
                });
                h.getLabel().attr(e);
                m && (c.clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function() {
                    h && h.move(b, d, a, g)
                }, 32))
            },
            hide: function(b) {
            ...
            getAnchor: function(b, d) {
                var a = this.chart,
                    ...
                    t, x;
                b = z(b);
                this.followPointer && d ? (void 0 === d.chartX && (d = c.normalize(d)), b = [d.chartX - a.plotLeft, d.chartY - e]) : b[0].tooltipPos ? b = b[0].tooltipPos : (b.forEach(function(a) {
                    t = a.series.yAxis;
                    x = a.series.xAxis;
                    u += a.plotX + (!h && x ? x.left - m : 0);
                    l += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!h && t ? t.top - e : 0)
                }), u /= b.length, l /= b.length, b = [h ? a.plotWidth - l : u, this.shared && !h && 1 < b.length && d ? d.chartY - e : h ? a.plotHeight - u : l]);
            ...
            getPosition: function(b, d, a) {
                var c = this.chart,
                    ...
                    m = c.inverted && a.h || 0,
                    u, l = this.outside,
                    t = l ? r.documentElement.clientWidth - 2 * h : c.chartWidth,
                    ...
                    q = function(e) {
                        var f = "x" === e;
                        return [e, f ? t : x, f ? b : d].concat(l ? [f ? B(b) : H(d), f ? k.left - h + B(a.plotX + c.plotLeft) : k.top - h + H(a.plotY + c.plotTop), 0, f ? t : x] : [f ? b : d, f ? a.plotX + c.plotLeft : a.plotY + c.plotTop, f ? c.plotLeft : c.plotTop, f ? c.plotLeft + c.plotWidth : c.plotTop + c.plotHeight])
                    },
                    f = q("y"),
                    n = q("x"),
                    N = !this.followPointer && w(a.ttBelow, !c.inverted === !! a.negative),
                    v = function(a, b, d, c, f, k, g) {
                        var q = "y" === a ? H(h) : B(h),
                            A = (d - c) / 2,
                            t = c < f - h,
                            u = f + h + c < b,
                    ...
                    p = function(a, b, d, c, f) {
                        var k;
                        f < h || f > b - h ? k = !1 : e[a] = f < d / 2 ? 1 : f > b - c / 2 ? b - c - 2 : f - d / 2;
                        return k
                    },
                    z = function(a) {
                        var b = f;
                    ...
                    L = function() {
                        !1 !== v.apply(0, f) ? !1 !== p.apply(0, n) || u || (z(!0), L()) : u ? e.x = e.y = 0 : (z(!0), L())
                    };
                (c.inverted || 1 < this.len) && z();
                L();
                return e
            },
            defaultFormatter: function(b) {
                var d = this.points || z(this);
                var a = [b.tooltipFooterHeaderFormatter(d[0])];
                a = a.concat(b.bodyFormatter(d));
                a.push(b.tooltipFooterHeaderFormatter(d[0], !0));
                return a
            },
            refresh: function(b, d) {
                ...
                if (g.enabled) {
                    c.clearTimeout(this.hideTimer);
                    this.followPointer = z(h)[0].series.tooltipOptions.followPointer;
                    var t = this.getAnchor(h, d);
                    d = t[0];
                    var x = t[1];
                    !e || h.series && h.series.noSharedTooltip ? e = h.getLabelConfig() : (a.pointer.applyInactiveState(h), h.forEach(function(a) {
                        a.setState("hover");
                    ...
                    !1 === u ? this.hide() : (a = this.getLabel(), this.isHidden && a.attr({
                        opacity: 1
                    }).show(), this.split ? this.renderSplit(u, z(b)) : (g.style.width && !l || a.css({
                        width: this.chart.spacingBox.width
                    }), a.attr({
                        text: u && u.join ? u.join("") : u
                    }), a.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + w(h.colorIndex, e.colorIndex)), l || a.attr({
                        stroke: g.borderColor || h.color || e.color || "#666666"
                    }), this.updatePosition({
                        plotX: d,
                        plotY: x,
                        negative: h.negative,
            ...
            renderSplit: function(b, d) {
                ...
                b.slice(0, d.length + 1).forEach(function(b, c) {
                    if (!1 !== b && "" !== b) {
                        ...
                        q || (q = {
                            padding: u.padding,
                            r: u.borderRadius
                        }, h.styledMode || (q.fill = u.backgroundColor, q["stroke-width"] = u.borderWidth), B.tt = q = e.label(null, null, null, (c.isHeader ? u.headerShape : u.shape) || "callout", null, null, u.useHTML).addClass("highcharts-tooltip-box " + A).attr(q).add(x));
                        q.isActive = !0;
                        q.attr({
                            text: b
                        });
                        h.styledMode || q.css(u.style).shadow(u.shadow).attr({
                            stroke: u.borderColor || c.color || f.color || "#333333"
                        });
                        b = q.getBBox();
                        ...
                        0 > b && (m = !1);
                        c.isHeader ? f = t ? -l : h.plotHeight + l : (f = f.yAxis, f = f.pos - k + Math.max(0, Math.min(c.plotY || 0, f.len)));
                        g.push({
                            target: f,
                            rank: c.isHeader ? 1 : 0,
                ...
                this.cleanSplit();
                u.positioner && g.forEach(function(b) {
                    var d = u.positioner.call(a, b.tt.getBBox().width, b.size, b.point);
                    b.x = d.x;
                    b.align = 0;
                    b.target = d.y;
                ...
                g.forEach(function(b) {
                    ...
                    b.tt.attr({
                        ...
                        y: b.pos + k,
                        anchorX: d.isHeader ? d.plotX + h.plotLeft : d.plotX + c.xAxis.pos,
            ...
            getDateFormat: function(b, d, a, c) {
                var g = this.chart.time,
                    ...
                    u = "millisecond";
                for (n in l) {
                    if (b === l.week && +g.dateFormat("%w", d) === a && "00:00:00.000" === e.substr(6)) {
                        var n = "week";
                        break
                    }
                    if (l[n] > b) {
            ...
            getXDateFormat: function(b, d, a) {
                d = d.dateTimeLabelFormats;
                var c = a && a.closestPointRange;
                return (c ? this.getDateFormat(c, b.x, a.options.startOfWeek, d) : d.day) || d.year
            },
            tooltipFooterHeaderFormatter: function(b, d) {
                ...
                c.fireEvent(this, "headerFormatter", d, function(a) {
                    u && !e && (e = this.getXDateFormat(b, h, m));
                    u && e && (b.point && b.point.tooltipDateKeys || ["key"]).forEach(function(a) {
                        l = l.replace("{point." + a + "}", "{point." + a + ":" + e + "}")
                    });
        ...
        c.Pointer.prototype = {
            ...
            zoomOption: function(a) {
                var b = this.chart,
                    ...
                    c = d.zoomType || "";
                b = b.inverted;
                /touch/.test(a.type) && (c = g(d.pinchType, c));
            ...
            findNearestKDPoint: function(a, b, d) {
                ...
                a.forEach(function(a) {
                    ...
                    if ((e = F(a, !0)) && !(e = !F(c, !0))) {
                        ...
                        e = 0 < (0 !== e && b ? e : 0 !== k ? k : 0 !== g ? g : c.series.index > a.series.index ? -1 : 1)
                    }
                    e && (c = a)
                });
                return c
            ...
            getHoverData: function(a, d, c, h, t, x) {
                var e, m = [];
                h = !(!h || !a);
                var B = d && !d.stickyTracking ? [d] : c.filter(function(a) {
                    return a.visible && !(!t && a.directTouch) && g(a.options.enableMouseTracking, !0) && a.stickyTracking
                });
                d = (e = h ? a : this.findNearestKDPoint(B, t, x)) && e.series;
                e && (t && !d.noSharedTooltip ? (B = c.filter(function(a) {
                    return a.visible && !(!t && a.directTouch) && g(a.options.enableMouseTracking, !0) && !a.noSharedTooltip
                }), B.forEach(function(a) {
                    var d = b(a.points, function(a) {
                        return a.x === e.x && !a.isNull
                    });
                    F(d) && (a.chart.isBoosting && (d = a.getPoint(d)), m.push(d))
                })) : m.push(e));
                return {
                    hoverPoint: e,
                    hoverSeries: d,
            ...
            runPointActions: function(a, b) {
                ...
                k = this.getHoverData(m, k, d.series, "touchmove" !== a.type && ( !! b || k && k.directTouch && this.isDirectTouch), h, a);
                m = k.hoverPoint;
                var A = k.hoverPoints;
                ...
                if (m && (m !== d.hoverPoint || e && e.isHidden)) {
                    ...
                    d.hoverPoint = m;
                    e && e.refresh(h ? A : m, a)
                } else b && e && !e.isHidden && (m = e.getAnchor([{}], a), e.updatePosition({
                    plotX: m[0],
                    plotY: m[1]
                }));
                this.unDocMouseMove || (this.unDocMouseMove = K(d.container.ownerDocument, "mousemove", function(a) {
                    var b = D[c.hoverChartIndex];
                    if (b) b.pointer.onDocumentMouseMove(a)
                }));
                d.axes.forEach(function(b) {
                    var d = g(b.crosshair.snap, !0),
                        e = d ? c.find(A, function(a) {
            ...
            reset: function(a, b) {
                ...
                if (a) k && h && r(h).length && (k.refresh(h), k.shared && g ? g.forEach(function(a) {
            ...
            drag: function(a) {
                ...
                if (!f || !f.touch) if (c < h ? c = h : c > h + H && (c = h + H), e < B ? e = B : e > B + q && (e = B + q), this.hasDragged = Math.sqrt(Math.pow(l - c, 2) + Math.pow(n - e, 2)), 10 < this.hasDragged) {
                    var v = b.isInsidePlot(l - h, n - B);
                    b.hasCartesianSeries && (this.zoomX || this.zoomY) && v && !r && !f && (this.selectionMarker = f = b.renderer.rect(h, B, g ? 1 : H, k ? 1 : q, 0).attr({
                        "class": "highcharts-selection-marker",
                        zIndex: 7
                    }).add(), b.styledMode || f.attr({
                        fill: d.selectionMarkerFill || w("#335cad").setOpacity(.25).get()
                    }));
                    f && g && (c -= l, f.attr({
                        width: Math.abs(c),
                        x: (0 < c ? 0 : c) + l
            ...
            onDocumentMouseUp: function(a) {
                D[c.hoverChartIndex] && D[c.hoverChartIndex].pointer.drop(a)
            },
            ...
            onContainerClick: function(a) {
                var b = this.chart,
                    ...
                    g = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (d(c.series, "click", l(a, {
                    point: c
                })), b.hoverPoint && c.firePointEvent("click", a)) : (l(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - e, a.chartY - g) && d(b, "click", a)))
            },
            setDOMEvents: function() {
                ...
                c.hasTouch && (K(b, "touchstart", function(b) {
                    a.onContainerTouchStart(b)
                }), K(b, "touchmove", function(b) {
                    a.onContainerTouchMove(b)
                }), c.unbindDocumentTouchEnd || (c.unbindDocumentTouchEnd = K(d, "touchend", a.onDocumentTouchEnd)))
            },
            destroy: function() {
                var a = this;
    ...
    M(J, "parts/TouchPointer.js", [J["parts/Globals.js"]], function(c) {
        ...
        y(c.Pointer.prototype, {
            pinchTranslate: function(c, r, p, v, y, w) {
                this.zoomHor && this.pinchTranslateDirection(!0, c, r, p, v, y, w);
            ...
            pinch: function(c) {
                ...
                }), n.x = [v[0].chartX, v[1] && v[1].chartX], n.y = [v[0].chartY, v[1] && v[1].chartY], p.axes.forEach(function(a) {
                    if (a.zoomEnabled) {
                ...
                }), r.res = !0) : r.followTouchMove && 1 === w ? this.runPointActions(r.normalize(c)) : v.length && (b || (r.selectionMarker = b = y({
                    destroy: G,
                    touch: !0
                }, p.plotBox)), r.pinchTranslate(v, z, d, b, g, n), r.hasPinched = l, r.scaleGroups(d, g), r.res && (r.res = !1, this.reset(!1, 0)))
            },
            touch: function(p, r) {
                var z = this.chart,
                    v;
                ...
                if (1 === p.touches.length) if (p = this.normalize(p), (v = z.isInsidePlot(p.chartX - z.plotLeft, p.chartY - z.plotTop)) && !z.openMenu) {
                    r && this.runPointActions(p);
                    if ("touchmove" === p.type) {
                        r = this.pinchDown;
                        var y = r[0] ? 4 <= Math.sqrt(Math.pow(r[0].chartX - p.chartX, 2) + Math.pow(r[0].chartY - p.chartY, 2)) : !1
                    }
                    F(y, !0) && this.pinch(p)
                } else r && this.reset();
            ...
            onDocumentTouchEnd: function(z) {
                p[c.hoverChartIndex] && p[c.hoverChartIndex].pointer.drop(z)
            }
        })
    });
    M(J, "parts/MSPointer.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        if (!c.hasTouch && (w.PointerEvent || w.MSPointerEvent)) {
            var l = {},
                ...
                a = function(a, b, e, m) {
                    "touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH || !F[c.hoverChartIndex] || (m(a), m = F[c.hoverChartIndex].pointer, m[b]({
                        type: e,
            ...
            n(v.prototype, "init", function(a, b, d) {
                a.call(this, b, d);
            ...
            n(v.prototype, "destroy", function(a) {
        ...
        c.Legend.prototype = {
            ...
            positionItem: function(a) {
                ...
                if ((a = a.legendGroup) && a.element) a[y(a.translateY) ? "animate" : "attr"]({
                    translateX: b ? m : this.legendWidth - m - 2 * d - 4,
                    translateY: c
                });
                l && (l.x = m, l.y = c)
            },
            ...
            positionCheckboxes: function() {
                ...
                if (a) {
                    ...
                    this.allItems.forEach(function(e) {
                        var g = e.checkbox;
                        if (g) {
                            var h = c + d + g.y + (this.scrollOffset || 0) + 3;
                            z(g, {
                                left: a.translateX + e.checkboxOffset + g.x - 20 + "px",
                                top: h + "px",
                                display: this.proximate || h > c - 6 && h < c + b - 6 ? "" : "none"
                            })
                        }
                    }, this)
                }
            ...
            renderItem: function(a) {
                ...
                A || (a.legendGroup = d.g("legend-item").addClass("highcharts-" + H.type + "-series highcharts-color-" + a.colorIndex + (C ? " " + C : "") + (B ? " highcharts-series-" + a.index : "")).attr({
                    zIndex: 1
                }).add(this.scrollGroup), a.legendItem = A = d.text("", k ? m + l : -l, this.baseline || 0, f), b.styledMode || A.css(D(a.visible ? n : t)), A.attr({
                    align: k ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup), this.baseline || (this.fontMetrics = d.fontMetrics(b.styledMode ? 12 : n.fontSize, A), this.baseline = this.fontMetrics.f + 3 + this.itemMarginTop, A.attr("y", this.baseline)), this.symbolHeight = c.symbolHeight || this.fontMetrics.f, H.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, A, f));
                q && !a.checkbox && this.createCheckboxForItem(a);
                this.colorizeItem(a, a.visible);
                !b.styledMode && n.width || A.css({
                    width: (c.itemWidth || this.widthOption || b.spacingBox.width) - x
                });
                this.setText(a);
                b = A.getBBox();
            ...
            layoutItem: function(a) {
                ...
                this.offsetWidth = this.widthOption || Math.max((c ? this.itemX - d - (a.checkbox ? 0 : t) : b) + d, this.offsetWidth)
            },
            ...
            adjustMargins: function(a, b) {
                ...
                g && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function(e, k) {
                    e.test(g) && !y(a[k]) && (d[v[k]] = Math.max(d[v[k]], d.legend[(k + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][k] * c[k % 2 ? "x" : "y"] + w(c.margin, 12) + b[k] + (0 === k && (0 === d.titleOffset[0] ? 0 : n)) + (2 === k && (0 === d.titleOffset[2] ? 0 : t))))
                })
            },
            proximatePositions: function() {
                ...
                this.allItems.forEach(function(e) {
                    ...
                    if (e.yAxis && e.points) {
                        ...
                        g = e.legendGroup.getBBox().height;
                        var l = e.yAxis.top - a.plotTop;
            ...
            render: function() {
                ...
                0 < t && 0 < x && (m[m.isNew ? "attr" : "animate"](m.crisp.call({}, {
                    x: 0,
                    y: 0,
                    width: t,
                    height: x
                ...
                this.legendWidth = t;
                this.legendHeight = x;
                e && (b = a.options.title.margin, m = a.spacingBox, w = m.y, /(lth|ct|rth)/.test(this.getAlignment()) && 0 < a.titleOffset[0] ? w += a.titleOffset[0] + b : /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < a.titleOffset[2] && (w -= a.titleOffset[2] + b), w !== m.y && (m = D(m, {
                    y: w
                })), d.align(D(n, {
                    width: t,
                    height: x,
            ...
            handleOverflow: function(a) {
                ...
                var t = m.maxHeight,
                    ...
                    v = function(a) {
                        b[a] = c.circle(0, 0, 1.3 * H).translate(H / 2, H / 2).add(q);
                ...
                t && (l = Math.min(l, t));
                f.length = 0;
                a > l && !1 !== A.enabled ? (this.clipHeight = x = Math.max(l - 20 - this.titleHeight - n, 0), this.currentPage = w(this.currentPage, 1), this.fullHeight = a, r.forEach(function(a, b) {
                    var d = a._legendItemPos[1],
                        c = Math.round(a.legendItem.getBBox().height),
                        k = f.length;
                    if (!k || d - f[k - 1] > x && (C || d) !== f[k - 1]) f.push(C || d), k++;
                    a.pageIx = k - 1;
                    C && (r[b - 1].pageIx = k - 1);
                    b === r.length - 1 && d + c - f[k - 1] > x && d !== C && (f.push(d), a.pageIx = k);
                    d !== C && (C = d)
                }), k || (k = b.clipRect = c.clipRect(0, n, 9999, 0), b.contentGroup.clip(k)), p(x), q || (this.nav = q = c.g().attr({
                    zIndex: 1
                }).add(this.group), this.up = c.symbol("triangle", 0, 0, H, H).add(q), v("upTracker").on("click", function() {
                    b.scroll(-1, B)
                }), this.pager = c.text("", 15, 10).addClass("highcharts-legend-navigation"), d.styledMode || this.pager.css(A.style), this.pager.add(q), this.down = c.symbol("triangle-down", 0, 0, H, H).add(q), v("downTracker").on("click", function() {
                    b.scroll(1, B)
                })), b.scroll(0), a = l) : q && (p(), this.nav = q.destroy(), this.scrollGroup.attr({
                    translateY: 1
                }), this.clipHeight = 0);
                return a
            },
            scroll: function(a, b) {
                ...
                var l = this.options.navigation,
                    ...
                    t = this.padding;
                g > c && (g = c);
                0 < g && (void 0 !== b && n(b, this.chart), this.nav.attr({
                    translateX: t,
                    ...
                    a.attr({
                        ...
                        "class": g === c ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
                    })
                    ...
                    fill: g === c ? l.inactiveColor : l.activeColor
                }), this.downTracker.css({
                    cursor: g === c ? "default" : "pointer"
                })), this.scrollOffset = -d[g - 1] + this.initialItemY, this.scrollGroup.animate({
                    translateY: this.scrollOffset
                }), this.currentPage = g, this.positionCheckboxes())
            }
        };
        c.LegendSymbolMixin = {
            drawRectangle: function(a, b) {
                ...
                b.legendSymbol = this.chart.renderer.rect(c ? (a.symbolWidth - d) / 2 : 0, a.baseline - d + 1, c ? d : a.symbolWidth, d, w(a.options.symbolRadius, d / 2)).addClass("highcharts-point").attr({
                    zIndex: 3
                }).add(b.legendGroup)
            },
            drawLineMarker: function(a) {
                ...
                d && !1 !== d.enabled && c && (b = Math.min(w(d.radius, l), l), 0 === this.symbol.indexOf("url") && (d = D(d, {
                    width: m,
                    height: m
                }), b = 0), this.legendSymbol = d = n.symbol(this.symbol, c / 2 - b, a - b, 2 * b, 2 * b, d).addClass("highcharts-point").add(t), d.isMarker = !0)
            }
        };
        (/Trident\/7\.0/.test(b.navigator && b.navigator.userAgent) || p) && d(c.Legend.prototype, "positionItem", function(a, b) {
            var d = this,
                c = function() {
    ...
    M(J, "parts/Chart.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        var y = p.defined,
            G = p.erase,
            F = p.isArray,
            z = p.isNumber,
        ...
        t(S.prototype, {
            ...
            init: function(a, b) {
                ...
                k(this, "init", {
                    ...
                    a.series = null;
                    d = H(e, a);
                    v(d.plotOptions, function(a, b) {
                        r(a) && (a.tooltip = g[b] && H(g[b].tooltip) || void 0)
                    });
            ...
            redraw: function(a) {
                ...
                if (x) for (a = d.length; a--;) n = d[a], n.options.stacking && (n.isDirty = !0);
                d.forEach(function(a) {
                    a.isDirty && ("point" === a.options.legendType ? (a.updateTotals && a.updateTotals(), h = !0) : g && (g.labelFormatter || g.labelFormat) && (h = !0));
                    a.isDirtyData && k(a, "updatedData")
                });
                h && e && e.options.enabled && (e.render(), this.isDirtyLegend = !1);
                H && this.getStacks();
                q && b.forEach(function(a) {
                    a.updateNames();
                    a.setScale()
                });
                this.getMargins();
            ...
            get: function(a) {
                ...
                var d = this.series,
                    c;
                var f = x(this.axes, b) || x(this.series, b);
                for (c = 0; !f && c < d.length; c++) f = x(d[c].points || [], b);
                return f
            },
            getAxes: function() {
                var a = this,
            ...
            getSelectedPoints: function() {
                ...
                this.series.forEach(function(b) {
                    a = a.concat((b[b.hasGroupedData ? "points" : "data"] || []).filter(function(a) {
                        return f(a.selectedStaging, a.selected)
                    }))
                });
                return a
            },
            ...
            setTitle: function(a, b, d) {
                ...
                [
                    ...
                    a = a[2];
                    f && e && (c[d] = f = f.destroy());
                    a && !f && (c[d] = c.renderer.text(a.text, 0, 0, a.useHTML).attr({
                        align: a.align,
                        "class": "highcharts-" + d,
                        zIndex: a.zIndex || 4
                    }).add(), c[d].update = function(a) {
                        c.setTitle(!b && a, b && a)
                    }, k || c[d].css(a.style))
                });
                c.layOutTitles(d)
            ...
            layOutTitles: function(a) {
                ...
                ["title", "subtitle"].forEach(function(a) {
                    ...
                    if (f) {
                        if (!this.styledMode) var g = k.style.fontSize;
                        g = d.fontMetrics(g, f).b;
                        f.css({
                            width: (k.width || c.width + k.widthAdjust) + "px"
                        });
                        var h = f.getBBox(k.useHTML).height;
                        f.align(t({
                            y: a ? g : e + g,
                            height: h
                        }, k), !1, "spacingBox");
                ...
                this.titleOffset = b;
                !this.isDirtyBox && k && (this.isDirtyBox = this.isDirtyLegend = k, this.hasRendered && f(a, !0) && this.isDirtyBox && this.redraw())
            },
            ...
            getContainer: function() {
                ...
                this.container = e = h("div", {
                    id: g
                }, q, e);
                this._cursor = e.style.cursor;
                this.renderer = new(c[f.renderer] || c.Renderer)(e, A, m, null, f.forExport, b.exporting && b.exporting.allowHTML, this.styledMode);
                this.setClassName(f.className);
                if (this.styledMode) for (B in b.defs) this.renderer.definition(b.defs[B]);
            ...
            reflow: function(b) {
                ...
                k = b ? b.target : R;
                if (!e && !d.isPrinting && g && f && (k === R || k === a)) {
                    if (g !== d.containerWidth || f !== d.containerHeight) c.clearTimeout(d.reflowTimeout), d.reflowTimeout = T(function() {
            ...
            setReflow: function(a) {
                var b = this;
                !1 === a || this.unbindReflow ? !1 === a && this.unbindReflow && (this.unbindReflow = this.unbindReflow()) : (this.unbindReflow = n(R, "resize", function(a) {
                    b.reflow(a)
            ...
            setChartSize: function(a) {
                ...
                this.clipBox = {
                    ...
                    height: Math.max(0, Math.floor(this.plotSizeY - Math.max(c, h[2]) / 2 - d))
                };
            ...
            drawChartBox: function() {
                ...
                if (h) var p = l = f.strokeWidth();
                    ...
                    if (p || f["stroke-width"]) B.stroke = a.borderColor, B["stroke-width"] = p;
                ...
                h || (e.attr({
                    fill: A || "none"
                }).shadow(a.plotShadow), m && (q ? q.animate(C) : this.plotBGImage = b.image(m, t, n, H, x).add()));
                u ? u.animate({
                    width: w.width,
                    height: w.height
            ...
            propFromSeries: function() {
                ...
                ["inverted", "angular", "polar"].forEach(function(e) {
                    d = N[b.type || b.defaultSeriesType];
                    k = b[e] || d && d.prototype[e];
                    for (f = c && c.length; !k && f--;)(d = N[c[f].type]) && d.prototype[e] && (k = !0);
                    a[e] = k
                })
            },
            linkSeries: function() {
            ...
            renderLabels: function() {
                ...
                b.items && b.items.forEach(function(d) {
                    ...
                    delete c.left;
                    delete c.top;
                    a.renderer.text(d.html, f, k).attr({
                        zIndex: 2
                    }).css(c).add()
                })
            },
            ...
            firstRender: function() {
                ...
                if (!a.isReadyToRender || a.isReadyToRender()) {
                    ...
                    a.propFromSeries();
                    a.getAxes();
                    (F(b.series) ? b.series : []).forEach(function(b) {
                        a.initSeries(b)
                    });
                    a.linkSeries();
                    k(a, "beforeRender");
    ...
    M(J, "parts/ScrollablePlotArea.js", [J["parts/Globals.js"]], function(c) {
        var p = c.addEvent,
            y = c.Chart;
        "";
        p(y, "afterSetChartSize", function(p) {
            ...
            if (!this.renderer.forExport) {
                ...
                } else y && (this.scrollablePixelsY = z = Math.max(0, y - this.chartHeight)) && (this.plotHeight += z, this.inverted ? (this.clipBox.width += z, this.plotBox.width += z) : (this.clipBox.height += z, this.plotBox.height += z), r = {
                    2: {
                        name: "bottom",
                        value: z
                    }
                });
                r && !p.skipAxes && this.axes.forEach(function(p) {
                    r[p.side] ? p.getPlotLinePath = function() {
                        var v = r[p.side].name,
                            z = this[v];
                        this[v] = z - r[p.side].value;
        ...
        y.prototype.applyFixed = function() {
            ...
            F ? (this.fixedDiv = c.createElement("div", {
                ...
                zIndex: -1
            }).addClass("highcharts-scrollable-mask").add(), this.moveFixedElements(), p(this, "afterShowResetZoom", this.moveFixedElements)) : this.fixedRenderer.setSize(this.chartWidth, this.chartHeight);
            ...
            F = this.scrollablePixelsX ? ["M", 0, F, "L", this.plotLeft - 1, F, "L", this.plotLeft - 1, y, "L", 0, y, "Z", "M", K, F, "L", this.chartWidth, F, "L", this.chartWidth, y, "L", K, y, "Z"] : this.scrollablePixelsY ? ["M", z, 0, "L", z, this.plotTop - 1, "L", r, this.plotTop - 1, "L", r, 0, "Z", "M", z, v, "L", z, this.chartHeight, "L", r, this.chartHeight, "L", r, v, "Z"] : ["M", 0, 0];
    ...
    M(J, "parts/Point.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        c.Point.prototype = {
            ...
            resolveColor: function() {
                ...
                this.colorIndex = n(this.colorIndex, c)
            },
            ...
            setNestedProperty: function(b, a, c) {
                c.split(".").reduce(function(b, d, c, g) {
                    b[d] = g.length - 1 === c ? a : r(b[d], !0) ? b[d] : {};
                    return b[d]
                }, b);
                return b
            },
            optionsToObject: function(b) {
                ...
                else if (F(b)) for (!h && b.length > m && (d = typeof b[0], "string" === d ? a.name = b[0] : "number" === d && (a.x = b[0]), l++); n < m;) h && void 0 === b[l] || (0 < e[n].indexOf(".") ? c.Point.prototype.setNestedProperty(a, b[l], e[n]) : a[e[n]] = b[l]), l++, n++;
            ...
            getZone: function() {
                ...
                var c = 0,
                    h;
                for (h = a[c]; this[b] >= h.value;) h = a[++c];
            ...
            firePointEvent: function(b, a, c) {
                ...
                (e.point.events[b] || d.options && d.options.events && d.options.events[b]) && this.importEvents();
                "click" === b && e.allowPointSelect && (c = function(a) {
    ...
    M(J, "parts/Series.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        c.Series = c.seriesType("line", null, {
            ...
            init: function(a, b) {
                ...
                var f = b.events;
                K(f, function(a, b) {
                    c.isFunction(a) && d.eventOptions[b] !== a && (c.isFunction(d.eventOptions[b]) && u(d, b, d.eventOptions[b]), d.eventOptions[b] = a, D(d, b, a))
                });
            ...
            insert: function(a) {
                var b = this.options.index,
                    d;
                if (z(b)) {
                    for (d = a.length; d--;) if (b >= m(a[d].options.index, a[d]._i)) {
                        a.splice(d + 1, 0, this);
                        break
                    } - 1 === d && a.unshift(this);
                    d += 1
                } else a.push(this);
                return m(d, a.length - 1)
            },
            bindAxes: function() {
                var a = this,
                    b = a.options,
            ...
            setOptions: function(a) {
                ...
                this.stickyTracking = m(a.stickyTracking, n[this.type] && n[this.type].stickyTracking, n.series && n.series.stickyTracking, this.tooltipOptions.shared && !this.noSharedTooltip ? !0 : g.stickyTracking);
                null === l.marker && delete g.marker;
                this.zoneAxis = g.zoneAxis;
                c = this.zones = (g.zones || []).slice();
                !g.negativeColor && !g.negativeFillColor || g.zones || (k = {
                    value: g[this.zoneAxis + "Threshold"] || g.threshold || 0,
                    className: "highcharts-negative"
                }, b || (k.color = g.negativeColor, k.fillColor = g.negativeFillColor), c.push(k));
                c.length && y(c[c.length - 1].value) && c.push(b ? {} : {
                    color: this.color,
            ...
            getCyclic: function(a, b, d) {
                var c = this.chart,
                    ...
                    f = a + "Index",
                    k = a + "Counter",
                    g = d ? d.length : m(c.options.chart[a + "Count"], c[a + "Count"]);
                if (!b) {
                    var h = m(e[f], e["_" + f]);
            ...
            findPointIndex: function(a, b) {
                ...
                var c = this.points,
                    e;
                if (d) {
                    var f = (d = this.chart.get(d)) && d.index;
                    void 0 !== f && (e = !0)
                }
                void 0 === f && z(a) && (f = this.xData.indexOf(a, b)); - 1 !== f && void 0 !== f && this.cropped && (f = f >= this.cropStart ? f - this.cropStart : f);
                !e && c[f] && c[f].touched && (f = void 0);
                return f
            },
            ...
            updateData: function(a) {
                ...
                a.forEach(function(a, f) {
                    var q = y(a) && this.pointClass.prototype.optionsToObject.call({
                        series: this
                    }, a) || {};
                    var m = q.x;
                    if (q.id || z(m)) if (m = this.findPointIndex(q, k), -1 === m || void 0 === m ? c.push(a) : d[m] && a !== b.data[m] ? (d[m].update(a, !1, null, !1), d[m].touched = !0, g && (k = m + 1)) : d[m] && (d[m].touched = !0), !h || f !== m || this.hasDerivedData) e = !0
                }, this);
                if (e) for (a = d.length; a--;)(f = d[a]) && !f.touched && f.remove(!1);
            ...
            setData: function(a, b, d, e) {
                ...
                if (!E) {
                    ...
                    if (t && h > t) {
                        for (d = 0; null === B && d < h;) B = a[d], d++;
                        if (z(B)) for (d = 0; d < h; d++) H[d] = this.autoIncrement(), x[d] = a[d];
                        else if (F(B)) if (u) for (d = 0; d < h; d++) B = a[d], H[d] = B[0], x[d] = B.slice(1, u + 1);
                        else for (w && (p = w.indexOf("x"), v = w.indexOf("y"), p = 0 <= p ? p : 0, v = 0 <= v ? v : 1), d = 0; d < h; d++) B = a[d], H[d] = B[p], x[d] = B[v];
                        else c.error(12, !1, l)
                    } else for (d = 0; d < h; d++) void 0 !== a[d] && (B = {
                        series: k
                    }, k.pointClass.prototype.applyOptions.apply(B, [a[d]]), k.updateParallelArrays(B, d));
            ...
            processData: function(a) {
                ...
                if (l && this.sorted && !m && (!h || e > h || this.forceCrop)) if (b[e - 1] < x || b[0] > u) b = [], d = [];
                else if (this.yData && (b[0] < x || b[e - 1] > u)) {
                    k = this.cropData(this.xData, this.yData, x, u);
                    b = k.xData;
                    d = k.yData;
                    k = k.start;
                    var w = !0
                }
                for (h = b.length || 1; --h;) if (e = n ? g(b[h]) - g(b[h - 1]) : b[h] - b[h - 1], 0 < e && (void 0 === p || e < p)) var p = e;
            ...
            cropData: function(a, b, d, c, e) {
                ...
                for (h = 0; h < f; h++) if (a[h] >= d) {
                    k = Math.max(0, h - e);
                    break
                }
                for (d = h; d < f; d++) if (a[d] > c) {
                    g = d + e;
                    break
                }
                return {
            ...
            generatePoints: function() {
                ...
                for (u = 0; u < l; u++) {
                    var w = n + u;
                    if (t) {
                        var p = (new m).init(this, [e[u]].concat(v(f[u])));
                        p.dataGroup = this.groupMap[u];
                        p.dataGroup.options && (p.options = p.dataGroup.options, g(p, p.dataGroup.options), delete p.dataLabels)
                    } else(p = d[w]) || void 0 === b[w] || (d[w] = p = (new m).init(this, b[w], e[u]));
                    p && (p.index = w, x[u] = p)
                }
                this.options.keys = a;
                if (d && (l !== (c = d.length) || t)) for (u = 0; u < c; u++) u !== n || t || (u += l), d[u] && (d[u].destroyElements(), d[u].plotX = void 0);
                this.data = d;
                this.points = x;
            ...
            translate: function() {
                ...
                for (n = 0; n < l; n++) {
                    ...
                    if (d && this.visible && M && M[K]) {
                        var X = this.getStackIndicator(X, K, this.index);
                        if (!D.isNull) {
                            var O = M[K];
                            var Y = O.points[X.key]
                        }
                    }
                    F(Y) && (J = Y[0], G = Y[1], J === w && X.key === M[K].base && (J = m(z(p) && p, g.min)), g.positiveValuesOnly && 0 >= J && (J = null), D.total = D.stackTotal = O.total, D.percentage = O.total && D.y / O.total * 100, D.stackY = G, O.setOffset(this.pointXOffset || 0, this.barW || 0));
                    ...
                    D.category = e && void 0 !== e[D.x] ? e[D.x] : D.x;
                    if (!D.isNull) {
                        void 0 !== Z && (E = Math.min(E, Math.abs(r - Z)));
                        var Z = r
                    }
            ...
            setClip: function(a) {
                var b = this.chart,
                    ...
                    h = b[g],
                    m = b[g + "m"];
                h || (a && (k.width = 0, e && (k.x = b.plotSizeX + (!1 !== d.clip ? 0 : b.plotTop)), b[g + "m"] = m = c.clipRect(e ? b.plotSizeX + 99 : -99, e ? -b.plotLeft : -b.plotTop, 99, e ? b.chartWidth : b.chartHeight)), b[g] = h = c.clipRect(k), h.count = {
                    length: 0
                });
            ...
            drawPoints: function() {
                ...
                var f = this.xAxis;
                var g = m(c.enabled, !f || f.isRadial ? !0 : null, this.closestPointRangePx >= c.enabledThreshold * c.radius);
                if (!1 !== c.enabled || this._hasPointMarkers) for (f = 0; f < a.length; f++) {
                    ...
                    if (x && !h.isNull) {
                        ...
                        if (d && !b.styledMode) d[l](this.pointAttribs(h, h.selected && "select"));
            ...
            getGraphPath: function(a, b, d) {
                ...
                a.forEach(function(k, q) {
                    ...
                    k.isNull && !y(b) && 0 < q ? m = !e.connectNulls : k.isNull && !b ? m = !0 : (0 === q || m ? q = ["M", k.plotX, k.plotY] : c.getPointSpline ? q = c.getPointSpline(a, k, q) : f ? (q = 1 === f ? ["L", n.plotX, t] : 2 === f ? ["L", (n.plotX + l) / 2, n.plotY, "L", (n.plotX + l) / 2, t] : ["L", l, n.plotY], q.push("L", l, t)) : q = ["L", l, t], h.push(k.x), f && (h.push(k.x), 2 === f && h.push(k.x)), g.push.apply(g, q), m = !1)
                });
                g.xMap = h;
            ...
            drawGraph: function() {
                ...
                e.forEach(function(e, k) {
                    ...
                    g ? (g.endX = a.preventGraphAnimation ? null : d.xMap, g.animate({
                        d: d
                    })) : d.length && (a[f] = g = a.chart.renderer.path(d).addClass(e[1]).attr({
                        zIndex: 1
                    }).add(a.group));
                    g && !c && (f = {
                        stroke: e[2],
                    ...
                    }, e[3] ? f.dashstyle = e[3] : "square" !== b.linecap && (f["stroke-linecap"] = f["stroke-linejoin"] = "round"), g[h](f).shadow(2 > k && b.shadow));
            ...
            applyZones: function() {
                ...
                if (c.length && (l || t) && x && void 0 !== x.min) {
                    ...
                    c.forEach(function(c, k) {
                        e = E ? y ? b.plotWidth : 0 : y ? 0 : x.toPixels(z.min) || 0;
                        ...
                        x.isXAxis ? (h = {
                            ...
                            width: p,
                            height: n
                        }, y || (h.x = b.plotHeight - h.x)) : (h = {
                            x: 0,
                            y: u ? r : w,
                            width: n,
                            height: p
                        }, y && (h.y = b.plotWidth - h.y));
                        u && d.isVML && (h = x.isXAxis ? {
                            x: 0,
                            y: E ? w : r,
                            height: h.width,
                            width: b.chartWidth
                        ...
                        g[k] ? g[k].animate(h) : g[k] = d.clipRect(h);
            ...
            plotGroup: function(a, b, d, c, e) {
                var f = this[a],
                    k = !f;
                k && (this[a] = f = this.chart.renderer.g().attr({
                    zIndex: c || .1
                }).add(e));
            ...
            render: function() {
                ...
                c && a.animate(!0);
                n.inverted = a.isCartesian || a.invertable ? l : !1;
                ...
                c && a.animate();
                g || (a.animationTimeout = t(function() {
                    a.afterAnimate()
                }, c));
                a.isDirty = !1;
                a.hasRendered = !0;
            ...
            searchKDTree: function(a, b, d) {
                function c(a, b, d, h) {
                    var m = b.point,
                        l = e.kdAxisArray[d % h],
                        q = m;
                    var t = y(a[f]) && y(m[f]) ? Math.pow(a[f] - m[f], 2) : null;
            ...
            pointPlacementToXValue: function() {
                ...
                "between" === a && (a = .5);
                z(a) && (a *= m(this.options.pointRange || this.xAxis.pointRange));
                return a
            }
        });
        ""
    ...
    M(J, "parts/Stacking.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        c.StackItem = function(c, n, l, b, d) {
            ...
            this.alignOptions = {
                align: n.align || (a ? l ? "left" : "right" : "center"),
                verticalAlign: n.verticalAlign || (a ? "middle" : l ? "bottom" : "top"),
                y: n.y,
                x: n.x
            };
        ...
        c.StackItem.prototype = {
            ...
            render: function(c) {
                ...
                this.label ? this.label.attr({
                    text: b,
                    visibility: "hidden"
                }) : (this.label = n.renderer.label(b, null, null, l.shape, null, null, l.useHTML, !1, "stack-labels"), b = {
                    text: b,
                    align: this.textAlign,
                    rotation: l.rotation,
                    padding: v(l.padding, 0),
                    visibility: "hidden"
                }, this.label.attr(b), n.styledMode || this.label.css(l.style), this.label.added || this.label.add(c));
            ...
            setOffset: function(c, n, l, b) {
                ...
                l = d.translate(l ? l : 0);
                l = y(b) && Math.abs(b - l);
                c = a.xAxis[0].translate(this.x) + c;
                ...
                if (n && d) {
                    ...
                    v(!b && this.options.crop, !0) && ((a = a.isInsidePlot(n.alignAttr.x - g.width / 2, n.alignAttr.y) && a.isInsidePlot(n.alignAttr.x + (a.inverted ? c ? -g.width : g.width : g.width / 2), n.alignAttr.y + g.height)) || n.hide())
                }
            },
            getStackBox: function(c, n, l, b, d, a, g) {
                var h = n.axis.reversed,
                    e = c.inverted;
                c = g.height + g.pos - (e ? c.plotLeft : c.plotTop);
                n = n.isNegative && !h || !n.isNegative && h;
                return {
                    x: e ? n ? b : b - a : l,
                    y: e ? c - l - d : n ? c - b - a : c - b,
                    width: e ? a : d,
                    height: e ? d : a
                }
            }
        ...
        p.prototype.buildStacks = function() {
            ...
            if (!this.isXAxis) {
                ...
                for (b = l; b--;) c[n ? b : l - b - 1].setStackedPoints();
                for (b = 0; b < l; b++) c[b].modifyStacks()
            }
        };
        p.prototype.renderStackTotals = function() {
            ...
            b || (this.stackTotalGroup = b = n.g("stack-labels").attr({
                visibility: "visible",
                zIndex: 6
            }).add());
        ...
        p.prototype.resetStacks = function() {
            var c = this,
                n = c.stacks;
            c.isXAxis || G(n, function(l) {
                G(l, function(b, d) {
                    b.touched < c.stacksTouched ? (b.destroy(), delete l[d]) : (b.total = null, b.cumulative = null)
                })
            })
        };
        ...
        D.prototype.setStackedPoints = function() {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                for (A = 0; A < b; A++) {
                    var B = p[A];
                    var H = n[A];
                    var q = this.getStackIndicator(q, B, this.index);
                    var f = q.key;
                    ...
                    "percent" === d ? (k = k ? e : m, u && t[k] && t[k][B] ? (k = t[k][B], C.total = k.total = Math.max(k.total, C.total) + Math.abs(H) || 0) : C.total = z(C.total + (Math.abs(H) || 0))) : C.total = z(C.total + (H || 0));
        ...
        D.prototype.modifyStacks = function() {
            ...
            c[a + "Stacker"] && [n, "-" + n].forEach(function(g) {
                for (var h = b.length, e, m; h--;) if (e = b[h], d = c.getStackIndicator(d, e, c.index, g), m = (e = l[g] && l[g][e]) && e.points[d.key]) c[a + "Stacker"](m, e, h)
            })
        };
        D.prototype.percentStacker = function(c, n, l) {
            n = n.total ? 100 / n.total : 0;
            c[0] = z(c[0] * n);
            c[1] = z(c[1] * n);
            this.stackedYData[l] = c[1]
        };
        D.prototype.getStackIndicator = function(c, n, l, b) {
            !y(c) || c.x !== n || b && c.key !== b ? c = {
                x: n,
                index: 0,
                key: b
            } : c.index++;
            c.key = [l, n, c.index].join();
            return c
        }
    });
    M(J, "parts/Dynamics.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        c.cleanRecursively = function(a, b) {
            var d = {};
            v(a, function(e, g) {
                if (r(a[g], !0) && !a.nodeType && b[g]) e = c.cleanRecursively(a[g], b[g]), Object.keys(e).length && (d[g] = e);
                else if (r(a[g]) || a[g] !== b[g]) d[g] = a[g]
            });
            return d
        };
        a(p.prototype, {
            ...
            showLoading: function(c) {
                ...
                m || (g.loadingDiv = m = b("div", {
                    className: "highcharts-loading highcharts-loading-hidden"
                }, null, g.container), g.loadingSpan = b("span", {
                    className: "highcharts-loading-inner"
                }, null, m), w(g, "redraw", q));
                m.className = "highcharts-loading";
                g.loadingSpan.innerHTML = e(c, h.lang.loading, "");
                g.styledMode || (d(m, a(l.style, {
                    zIndex: 10
                })), d(g.loadingSpan, l.labelStyle), g.loadingShown || (d(m, {
                    opacity: 0,
                    display: ""
                }), n(m, {
            ...
            hideLoading: function() {
                var a = this.options,
                    b = this.loadingDiv;
                b && (b.className = "highcharts-loading highcharts-loading-hidden", this.styledMode || n(b, {
                    opacity: 0
                }, {
            ...
            update: function(a, b, d, m) {
                ...
                if (f = a.chart) {
                    ...
                    "alignTicks" in f && (u = !0);
                    v(f, function(a, b) {
                        -1 !== k.propsRequireUpdateSeries.indexOf("chart." + b) && (n = !0); - 1 !== k.propsRequireDirtyBox.indexOf(b) && (k.isDirtyBox = !0);
                ...
                v(a, function(a, b) {
                    ...
                    else if ("function" === typeof k[l[b]]) k[l[b]](a);
                    "chart" !== b && -1 !== k.propsRequireUpdateSeries.indexOf(b) && (n = !0)
                });
                    ...
                    if (a[b]) {
                        if ("series" === b) {
                            ...
                            k[b].forEach(function(a, b) {
                                a.options.isInternal || c.push(e(a.options.index, b))
                            })
                        }
                        D(a[b]).forEach(function(a, e) {
                            (e = y(a.id) && k.get(a.id) || k[b][c ? c[e] : e]) && e.coll === b && (e.update(a, !1), d && (e.touched = !0));
                ...
                u && k.axes.forEach(function(a) {
                    a.update({}, !1)
                });
                n && k.series.forEach(function(a) {
                    a.update({}, !1)
                });
                a.loading && h(!0, k.options.loading, a.loading);
                u = f && f.width;
                f = f && f.height;
                K(f) && (f = c.relativeLength(f, u || k.chartWidth));
        ...
        p.prototype.collectionsWithInit = {
            xAxis: [p.prototype.addAxis, [!0]],
            yAxis: [p.prototype.addAxis, [!1]],
            series: [p.prototype.addSeries]
        };
        a(m.prototype, {
            update: function(a, b, d, c) {
                function g() {
                    ...
                    r(a, !0) && (h && h.element && a && a.marker && void 0 !== a.marker.symbol && (k.graphic = h.destroy()), a && a.dataLabels && k.dataLabel && (k.dataLabel = k.dataLabel.destroy()), k.connector && (k.connector = k.connector.destroy()));
                    m = k.index;
        ...
        a(u.prototype, {
            addPoint: function(a, b, d, c, h) {
                ...
                var A = u.x;
                var p = t.length;
                if (this.requireSorting && A < t[p - 1]) for (x = !0; p && t[p - 1] > A;) p--;
            ...
            update: function(b, d) {
                ...
                var k = this,
                    ...
                    t = !(this.hasDerivedData || b.dataGrouping || f && f !== this.type || void 0 !== b.pointStart || b.pointInterval || b.pointIntervalUnit || b.keys),
                    u = E[n].prototype,
                    x, p = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"],
                    r = ["eventOptions", "navigatorSeries", "baseSeries"],
                    v = k.finishedAnimating && {
                        animation: !1
                    },
                    w = {};
                ...
                b = h(l, v, {
                    index: void 0 === l.index ? k.index : l.index,
                    pointStart: e(l.pointStart, k.xData[0])
                }, !t && {
                    data: k.options.data
                }, b);
                ...
                if (t && this.points) {
                    var y = k.options;
                    !1 === y.visible ? (w.graphic = 1, w.dataLabel = 1) : k._hasPointLabels || (f = y.marker, u = y.dataLabels, f && (!1 === f.enabled || "symbol" in f) && (w.graphic = 1), u && !1 === u.enabled && (w.dataLabel = 1));
                    this.points.forEach(function(a) {
                        a && a.series && (a.resolveColor(), Object.keys(w).length && a.destroyElements(w), !1 === y.showInLegend && a.legendItem && m.legend.destroyItem(a))
                    }, this)
                }
                b.zIndex !== l.zIndex && p.forEach(function(a) {
                    k[a] && k[a].attr({
                        zIndex: b.zIndex
                    })
                });
        ...
        a(l.prototype, {
            update: function(b, d) {
                ...
                v(c.options[this.coll].events, function(a, b) {
    ...
    M(J, "parts/AreaSeries.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        p("area", "line", {
            ...
            getStackPoints: function(c) {
                ...
                if (this.options.stacking) {
                    ...
                    r.forEach(function(d, c) {
                        var m = 0,
                            t, u;
                        if (l[d] && !l[d].isNull) p.push(l[d]), [-1, 1].forEach(function(k) {
                            var m = 1 === k ? "rightNull" : "leftNull",
                                p = 0,
                                x = n[r[c + k]];
                            if (x) for (h = b; 0 <= h && h < a;) t = x.points[h], t || (h === b ? l[d][m] = !0 : e[h] && (u = n[d].points[h]) && (p -= u[1] - u[0])), h += g;
            ...
            getGraphPath: function(p) {
                ...
                var e = function(c, e, k) {
                    ...
                    if (k || n) {
                        ...
                        var q = c[0] + k;
                        m = !! n
                    } else!y && p[e] && p[e].isNull && (t = q = g);
                    void 0 !== t && (b.push({
                        plotX: u,
                        plotY: null === t ? h : w.getThreshold(t),
                        isNull: m,
                        isCliff: !0
                    }), l.push({
                        plotX: u,
                        plotY: null === q ? h : w.getThreshold(q),
                        doCurve: !1
                    }))
                };
                p = p || this.points;
                ...
                for (n = 0; n < p.length; n++) {
                    var m = p[n].isNull;
                    var u = F(p[n].rectPlotX, p[n].plotX);
                    var E = F(p[n].yBottom, h);
                    if (!m || v) v || e(n, n - 1, "left"), m && !y && v || (b.push(p[n]), l.push({
                        x: n,
                        plotX: u,
                        plotY: E
                    })), v || e(n, n + 1, "right")
            ...
            drawGraph: function() {
                ...
                this.zones.forEach(function(p, n) {
                    y.push(["zone-area-" + n, "highcharts-area highcharts-zone-area-" + n + " " + p.className, p.color || c.color, p.fillColor || v.fillColor])
                });
                y.forEach(function(r) {
                    var n = r[0],
                        ...
                        b = l ? "animate" : "attr",
                        d = {};
                    l ? (l.endX = c.preventGraphAnimation ? null : p.xMap, l.animate({
                        d: p
                    })) : (d.zIndex = 0, l = c[n] = c.chart.renderer.path(p).addClass(r[1]).add(c.group), l.isArea = !0);
    ...
    M(J, "parts/AreaSplineSeries.js", [J["parts/Globals.js"]], function(c) {
        ...
        y("areaspline", "spline", c.defaultPlotOptions.area, {
            getStackPoints: p.getStackPoints,
            getGraphPath: p.getGraphPath,
            drawGraph: p.drawGraph,
            drawLegendSymbol: c.LegendSymbolMixin.drawRectangle
        });
        ""
    });
    M(J, "parts/ColumnSeries.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        p("column", "line", {
            ...
            init: function() {
                ...
                var c = this,
                    l = c.chart;
                l.hasRendered && l.series.forEach(function(b) {
            ...
            getColumnMetrics: function() {
                ...
                var g, h = {},
                    e = 0;
                !1 === l.grouping ? e = 1 : c.chart.series.forEach(function(a) {
                    var b = a.yAxis,
                        k = a.options;
                    if (a.type === c.type && (a.visible || !c.chart.options.chart.ignoreHiddenSeries) && d.len === b.len && d.pos === b.pos) {
                        if (k.stacking) {
                            g = a.stackKey;
                            void 0 === h[g] && (h[g] = e++);
                            var m = h[g]
                        } else!1 !== k.grouping && (m = e++);
                        a.columnIndex = m
                    }
                });
                var m = Math.min(Math.abs(b.transA) * (b.ordinalSlope || l.pointRange || b.closestPointRange || b.tickInterval || 1), b.len),
                    u = m * l.groupPadding,
                    p = (m - 2 * u) / (e || 1);
                l = Math.min(l.maxPointWidth || b.len, v(l.pointWidth, p * (1 - 2 * l.pointPadding)));
                c.columnMetrics = {
                    width: l,
                    offset: (p - l) / 2 + (u + ((c.columnIndex || 0) + (a ? 1 : 0)) * p - m / 2) * (a ? -1 : 1)
                };
            ...
            translate: function() {
                ...
                c.points.forEach(function(b) {
                    ...
                    if (e && Math.abs(w) < e) {
                        ...
                        A = Math.abs(A - h) > e ? d - e : h - (z ? e : 0)
                    }
                    y(b.options.pointWidth) && (n = u = Math.ceil(b.options.pointWidth), f -= Math.round((n - p) / 2));
                    b.barX = f;
                    b.pointWidth = n;
            ...
            pointAttribs: function(c, l) {
                ...
                if (c && this.zones.length) {
                    ...
                    p && (e = p.borderColor || e, d = p.dashStyle || d, m = p.borderWidth || m)
                }
                l && (c = K(b.states[l], c.options.states && c.options.states[l] || {}), l = c.brightness, h = c.color || void 0 !== l && z(h).brighten(c.brightness).get() || h, e = c[a] || e, m = c[g] || m, d = c.dashStyle || d, n = v(c.opacity, n));
                a = {
                    fill: h,
                    stroke: e,
                    "stroke-width": m,
            ...
            animate: function(c) {
                ...
                if (w) if (c) g.scaleY = .001, c = Math.min(b.pos + b.len, Math.max(b.pos, b.toPixels(d.threshold))), a ? g.translateX = c - b.len : g.translateY = c, l.clipBox && l.setClip(), l.group.attr(g);
                else {
                    var e = l.group.attr(h);
                    l.group.animate({
                        scaleY: 1
                    }, r(F(l.options.animation), {
                        step: function(a, d) {
                            g[h] = e + d.pos * (b.pos - e);
                            l.group.attr(g)
                        }
    ...
    M(J, "parts/ScatterSeries.js", [J["parts/Globals.js"]], function(c) {
                ...
                p && this.points.forEach(function(r, z) {
                    ["x", "y"].forEach(function(v, D) {
                        ...
                        if (p[v] && !r.isNull) {
                            ...
                            var l = p[v] * n.transA;
                            if (n && !n.isLog) {
                                var b = Math.max(0, r[w] - l);
                                n = Math.min(n.len, r[w] + l);
                                D = 1E4 * Math.sin(z + D * y);
                                r[w] = b + (n - b) * (D - Math.floor(D));
                                "x" === v && (r.clientX = r.plotX)
                            }
                        }
                    })
                })
        ...
        c.addEvent(p, "afterTranslate", function() {
    ...
    M(J, "parts/PieSeries.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        n("pie", "line", {
            ...
            updateTotals: function() {
                ...
                for (b = 0; b < c; b++) {
                    var e = a[b];
                    d += h && !e.visible ? 0 : e.isNull ? 0 : e.y
                }
                this.total = d;
                for (b = 0; b < c; b++) e = a[b], e.percentage = 0 < d && (e.visible || !h) ? e.y / d * 100 : 0, e.total = d
            },
            generatePoints: function() {
            ...
            getX: function(b, d, a) {
                ...
                return c[0] + (d ? -1 : 1) * Math.cos(Math.asin(Math.max(Math.min((b - c[1]) / (h + a.labelDistance), 1), -1))) * (h + a.labelDistance) + (0 < a.labelDistance ? (d ? -1 : 1) * this.options.dataLabels.padding : 0)
            },
            translate: function(b) {
                ...
                for (t = 0; t < p; t++) {
                    ...
                    k.labelPosition = {
                        natural: {
                            x: b[0] + w + Math.cos(r) * k.labelDistance,
                            y: b[1] + q + Math.sin(r) * k.labelDistance
                        },
                        "final": {},
                        alignment: 0 > k.labelDistance ? "center" : k.half ? "right" : "left",
                        connectorPosition: {
                            breakAt: {
                                x: b[0] + w + Math.cos(r) * A,
                                y: b[1] + q + Math.sin(r) * A
                            },
                            touchingSliceAt: {
                                x: b[0] + w,
                                y: b[1] + q
            ...
            redrawPoints: function() {
                ...
                !l || b.shadowGroup || d.styledMode || (b.shadowGroup = a.g("shadow").attr({
                    zIndex: -1
                }).add(b.group));
                b.points.forEach(function(g) {
                    ...
                    if (!g.isNull && h) {
                        ...
                        if (!d.styledMode) {
                            ...
                            n && n.attr(c);
                            e = b.pointAttribs(g, g.selected && "select")
                        }
                        g.delayedRendering ? (h.setRadialReference(b.center).attr(m).attr(c), d.styledMode || h.attr(e).attr({
                            "stroke-linejoin": "round"
                        }).shadow(l, n), g.delayedRendering = !1) : (h.setRadialReference(b.center), d.styledMode || r(!0, t, e), r(!0, t, m, c), h.animate(t));
                        h.attr({
            ...
            setVisible: function(b, c) {
                ...
                c = v(c, e);
                b !== a.visible && (a.visible = a.options.visible = b = void 0 === b ? !a.visible : b, d.options.data[d.data.indexOf(a)] = a.options, ["graphic", "dataLabel", "connector", "shadowGroup"].forEach(function(c) {
                    if (a[c]) a[c][b ? "show" : "hide"](!0)
                }), a.legendItem && h.legend.colorizeItem(a, b), b || "hover" !== a.state || a.setState(""), e && (d.isDirty = !0), c && h.redraw())
            },
            ...
            connectorShapes: {
                fixedOffset: function(b, c, a) {
                    var d = c.breakAt;
                    c = c.touchingSliceAt;
                    return ["M", b.x, b.y].concat(a.softConnector ? ["C", b.x + ("left" === b.alignment ? -5 : 5), b.y, 2 * d.x - c.x, 2 * d.y - c.y, d.x, d.y] : ["L", d.x, d.y]).concat(["L", c.x, c.y])
                },
                ...
                crookedLine: function(b, d, a) {
                    ...
                    h = ["L", a, b.y];
                    if ("left" === g ? a > b.x || a < d.x : a < b.x || a > d.x) h = [];
                    return ["M", b.x, b.y].concat(h).concat(["L", d.x, d.y])
                }
            },
    ...
    M(J, "parts/DataLabels.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        c.distribute = function(a, b, h) {
            ...
            if (p > k) {
                ...
                for (p = g = 0; p <= k;) p += a[g].size, g++;
                t = a.splice(g - 1, a.length)
            }
            d(a, e);
            for (a = a.map(function(a) {
                ...
                g = a.length;
                for (l = !1; g--;) 0 < g && a[g - 1].pos + a[g - 1].size > a[g].pos && (a[g - 1].size += a[g].size, a[g - 1].targets = a[g - 1].targets.concat(a[g].targets), a[g - 1].align = .5, a[g - 1].pos + a[g - 1].size > b && (a[g - 1].pos = b - a[g - 1].size), a.splice(g, 1), l = !0)
            }
            n.push.apply(n, t);
            g = 0;
            a.some(function(a) {
                ...
                if (a.targets.some(function() {
                    n[g].pos = a.pos + d;
                    if (Math.abs(n[g].pos - n[g].target) > h) return n.slice(0, g + 1).forEach(function(a) {
                        delete a.pos
                    }), n.reducedLen = (n.reducedLen || b) - .1 * b, n.reducedLen > .1 * b && c.distribute(n, b, h), !0;
                    d += n[g].size;
                    g++
                })) return !0
            });
        ...
        l.prototype.drawDataLabels = function() {
            ...
            function b(a, b) {
                var c = [],
                    d;
                if (G(a) && !G(b)) c = a.map(function(a) {
                    return D(a, b)
                });
                else if (G(b) && !G(a)) c = b.map(function(b) {
                    return D(a, b)
                });
                else if (G(a) || G(b)) for (d = Math.max(a.length, b.length); d--;) c[d] = D(a[d], b[d]);
                else c = D(a, b);
                return c
            }
            var d = this,
            ...
            if (G(n) || n.enabled || d._hasPointLabels) {
                ...
                B && (q.attr({
                    ...
                    a && (d.visible && q.show(!0), a[l.animation ? "animate" : "attr"]({
                        opacity: 1
                    }, {
                        duration: A
                    }))
                ...
                p.forEach(function(c) {
                    ...
                    t.forEach(function(b, f) {
                        ...
                        if (g) {
                            ...
                            var p = w(b[c.formatPrefix + "Format"], b.format);
        ...
        l.prototype.alignDataLabel = function(a, b, c, d, l) {
            var e = this.chart,
                ...
                h = w(a.dlBox && a.dlBox.centerX, a.plotX, -9999),
                m = w(a.plotY, -9999),
                k = b.getBBox(),
                n = c.rotation,
                p = c.align,
            ...
            if (r) {
                ...
                d = K({
                    x: g ? this.yAxis.len - m : h,
                    y: Math.round(g ? this.xAxis.len - h : m),
                    width: 0,
                    height: 0
                }, d);
                K(c, {
                ...
                n ? (q = !1, h = e.renderer.rotCorr(f, n), h = {
                    ...
                    align: p
                }), m = (n + 720) % 360, m = 180 < m && 360 > m, "left" === p ? h.y -= m ? k.height : 0 : "center" === p ? (h.x -= k.width / 2, h.y -= k.height / 2) : "right" === p && (h.x -= k.width, h.y -= m ? 0 : k.height), b.placed = !0, b.alignAttr = h) : (b.align(c, null, d), h = b.alignAttr);
        ...
        l.prototype.justifyDataLabel = function(a, b, c, d, l, n) {
            ...
            var m = c.x + k;
            if (0 > m) {
                "right" === g ? (b.align = "left", b.inside = !0) : b.x = -m;
                var p = !0
            }
            m = c.x + d.width - k;
            ...
            m = c.y + d.height - k;
            m > e.plotHeight && ("top" === h ? (b.verticalAlign = "bottom", b.inside = !0) : b.y = e.plotHeight - m, p = !0);
        ...
        b.pie && (b.pie.prototype.dataLabelPositioners = {
            ...
            a.visible && (m.enabled || a._hasPointLabels) && (b.forEach(function(a) {
            ...
            }), l.prototype.drawDataLabels.apply(a), b.forEach(function(a) {
                a.dataLabel && (a.visible ? (J[a.half].push(a), a.dataLabel._pos = null, !y(m.style.width) && !y(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > A && (a.dataLabel.css({
                    width: .7 * A
                }), a.dataLabel.shortened = !0)) : (a.dataLabel = a.dataLabel.destroy(), a.dataLabels && 1 === a.dataLabels.length && delete a.dataLabels))
            }), J.forEach(function(b, g) {
                var h = b.length,
                    l = [],
                    p;
                if (h) {
                    ...
                    if (0 < a.maxLabelDistance) {
                        var r = Math.max(0, f - q - a.maxLabelDistance);
                        var u = Math.min(f + q + a.maxLabelDistance, e.plotHeight);
                        b.forEach(function(a) {
                            0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, f - q - a.labelDistance), a.bottom = Math.min(f + q + a.labelDistance, e.plotHeight), p = a.dataLabel.getBBox().height || 21, a.distributeBox = {
                    ...
                    for (Q = 0; Q < h; Q++) {
                        ...
                        if (m.justify) L = U.justify(d, q, z);
                            ...
                            case "connectors":
                                L = U.alignToConnectors(b, g, t, k);
                                break;
                            case "plotEdges":
                                L = U.alignToPlotEdges(C, g, t, k);
                                break;
                            default:
                                L = U.radialDistributionX(a, d, I, r)
                        }
                        C._attr = {
                            visibility: M,
                            align: K.alignment
                ...
                if (p = w(W.connectorWidth, 1)) {
                    var c;
                    v = b.connector;
                    if ((C = b.dataLabel) && C._pos && b.visible && 0 < b.labelDistance) {
                        M = C._attr.visibility;
                        if (c = !v) b.connector = v = e.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + b.colorIndex + (b.className ? " " + b.className : "")).add(a.dataLabelsGroup), e.styledMode || v.attr({
                            "stroke-width": p,
            ...
            var b = this.center,
                ...
                p = null !== c.size;
            if (!p) {
                if (null !== d[0]) var r = Math.max(b[2] - Math.max(a[1], a[3]), l);
        ...
        b.column && (b.column.prototype.alignDataLabel = function(a, b, c, d, m) {
            ...
            h && (d = D(h), 0 > d.y && (d.height += d.y, d.y = 0), h = d.y + d.height - g.yAxis.len, 0 < h && (d.height -= h), e && (d = {
                x: g.yAxis.len - d.y - d.height,
                y: g.xAxis.len - d.x - d.width,
                width: d.height,
                height: d.width
            }), k || (e ? (d.x += n ? 0 : d.width, d.width = 0) : (d.y += n ? d.height : 0, d.height = 0)));
            c.align = w(c.align, !e || k ? "center" : n ? "right" : "left");
            c.verticalAlign = w(c.verticalAlign, e || k ? "middle" : n ? "top" : "bottom");
            l.prototype.alignDataLabel.call(this, a, b, c, d, m);
    ...
    M(J, "modules/overlapping-datalabels.src.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        z(p, "render", function() {
            ...
            (this.yAxis || []).forEach(function(p) {
                p.options.stackLabels && !p.options.stackLabels.allowOverlap && G(p.stacks, function(p) {
                    G(p, function(p) {
                        c.push(p.label)
                    })
                })
            ...
            (this.series || []).forEach(function(p) {
                ...
                p.visible && (!1 !== r.enabled || p._hasPointLabels) && p.points.forEach(function(p) {
                    p.visible && (y(p.dataLabels) ? p.dataLabels : p.dataLabel ? [p.dataLabel] : []).forEach(function(n) {
                        var l = n.options;
        ...
        p.prototype.hideOverlappingLabels = function(c) {
            ...
            var d = function(a) {
                ...
                if (a && (!a.alignAttr || a.placed)) {
                    ...
                    var g = a.parentGroup;
                    a.width || (c = a.getBBox(), a.width = c.width, a.height = c.height, c = w.fontMetrics(null, a.element).h);
                    return {
                        x: d.x + (g.translateX || 0) + b,
                        y: d.y + (g.translateY || 0) + b - c,
                        width: a.width - 2 * b,
                        height: a.height - 2 * b
                    }
                }
            };
            for (l = 0; l < y; l++) if (n = c[l]) n.oldOpacity = n.opacity, n.newOpacity = 1, n.absoluteBox = d(n);
            c.sort(function(a, b) {
            ...
            for (l = 0; l < y; l++) {
                ...
                for (n = l + 1; n < y; ++n) {
                    var g = (b = c[n]) && b.absoluteBox;
                    !a || !g || d === b || 0 === d.newOpacity || 0 === b.newOpacity || g.x > a.x + a.width || g.x + g.width < a.x || g.y > a.y + a.height || g.y + g.height < a.y || ((d.labelrank < b.labelrank ? d : b).newOpacity = 0)
                }
            }
            c.forEach(function(a) {
                var b;
                if (a) {
                    ...
                    a.oldOpacity !== c && (a.alignAttr && a.placed ? (c ? a.show(!0) : b = function() {
                        a.hide(!0);
                        a.placed = !1
                    }, a.alignAttr.opacity = c, a[a.isOld ? "animate" : "attr"](a.alignAttr, null, b), r(p, "afterHideOverlappingLabels")) : a.attr({
                        opacity: c
                    }));
                    a.isOld = !0
                }
        ...
        var E = c.TrackerMixin = {
            drawTrackerPoint: function() {
                ...
                a.points.forEach(function(a) {
                    g = G(a.dataLabels) ? a.dataLabels : a.dataLabel ? [a.dataLabel] : [];
                ...
                a._hasTracking || (a.trackerGroups.forEach(function(g) {
                    if (a[g]) {
                        ...
                        if (b) a[g].on("touchstart", e);
                        !c.styledMode && a.options.cursor && a[g].css(v).css({
            ...
            drawTrackerGraph: function() {
                ...
                if (g && !d) for (r = g + 1; r--;)"M" === e[r] && e.splice(r + 1, 0, e[r + 1] - n, e[r + 2], "L"), (r && "M" === e[r] || r === g) && e.splice(r, 0, "L", e[r - 2] + n, e[r - 1]);
                p ? p.attr({
                    d: e
                }) : a.graph && (a.tracker = f.path(e).attr({
                    ...
                    if (b) a.on("touchstart", w)
                }));
                l(this, "afterDrawTracker")
            }
        };
        m.column && (m.column.prototype.drawTracker = E.drawTrackerPoint);
        ...
        n(d.prototype, {
            setItemEvents: function(b, c, d) {
                ...
                (d ? c : b.legendGroup).on("mouseover", function() {
                    ...
                    b.firePointEvent ? b.firePointEvent("legendItemClick", a, c) : l(b, "legendItemClick", a, c)
                })
            },
                ...
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === e.enabled || a && (p || m && !1 === f.enabled) || a && t.states && t.states[a] && !1 === t.states[a].enabled)) {
                    ...
                    if (this.graphic) {
                        ...
                        if (a && f) {
                            ...
                            !u.styledMode && r && r.attr(c.pointAttribs(this, a))
                        }
                        r && (r[a && this.isInside ? "show" : "hide"](), r.element.point = this)
                    }
                    a = e.halo;
                    e = (r = this.graphic || r) && r.visibility || "inherit";
                    a && a.size && "hidden" !== e ? (x || (c.halo = x = u.renderer.path().add(r.parentGroup)), x.show()[b ? "animate" : "attr"]({
                        d: this.haloPath(a.size)
                    }), x.attr({
                        "class": "highcharts-halo highcharts-color-" + g(this.colorIndex, c.colorIndex) + (this.className ? " " + this.className : ""),
                        visibility: e,
                        zIndex: -1
                    }), x.point = this, u.styledMode || x.attr(n({
        ...
        n(e.prototype, {
            ...
            setState: function(a, b) {
                ...
                if (c.state !== a && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function(b) {
                    ...
                    a && (f = l[a].lineWidth || f + (l[a].lineWidthPlus || 0), m = g(l[a].opacity, m));
                    if (e && !e.dashstyle) for (l = {
                        "stroke-width": f
                    }, e.animate(l, n); c["zone-graph-" + d];) c["zone-graph-" + d].attr(l), d += 1;
    ...
    M(J, "parts/Responsive.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function(c, p) {
        ...
        p.prototype.setResponsive = function(p, r) {
            ...
            !r && v && v.rules && v.rules.forEach(function(l) {
                void 0 === l._id && (l._id = c.uniqueKey());
                this.matchResponsiveRule(l, w)
            }, this);
            r = c.merge.apply(0, w.map(function(l) {
                return c.find(v.rules, function(b) {
                    return b._id === l
                }).chartOptions
            }));
            r.isResponsiveOptions = !0;
            w = w.toString() || void 0;
            w !== (n && n.ruleIds) && (n && this.update(n.undoOptions, p, !0), w ? (n = this.currentOptions(r), n.isResponsiveOptions = !0, this.currentResponsive = {
                ruleIds: w,
                mergedOptions: r,
                undoOptions: n
            }, this.update(r, p, !0)) : this.currentResponsive = void 0)
        };
        p.prototype.matchResponsiveRule = function(c, p) {
            var v = c.condition;
            (v.callback ||
                function() {
                    return this.chartWidth <= r(v.maxWidth, Number.MAX_VALUE) && this.chartHeight <= r(v.maxHeight, Number.MAX_VALUE) && this.chartWidth >= r(v.minWidth, 0) && this.chartHeight >= r(v.minHeight, 0)
                }).call(this) && p.push(c._id)
        };
        p.prototype.currentOptions = function(c) {
            function p(c, l, b, d) {
                var a;
                F(c, function(c, h) {
                    if (!d && -1 < r.collectionsWithUpdate.indexOf(h)) for (c = z(c), b[h] = [], a = 0; a < c.length; a++) l[h][a] && (b[h][a] = {}, p(c[a], l[h][a], b[h][a], d + 1));
